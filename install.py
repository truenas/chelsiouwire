...
class prompt:
    ...
    benchtools = False
    global setkpath
    customTarget = [ 'bonding', 'vnic','nic', 'nic_offload', 'lio', 'iser', 'crypto', 'wdtoe', 'toe','iwarp','sniffer','fcoe_full_offload_initiator','iscsi_pdu_target',
                     'fcoe_pdu_offload_target', 'iscsi_pdu_initiator', 'dpdk', 'ovs', 'tools', 'nvme_toe', 'nvme_toe_spdk' ]
    supportMatrix = {"3.0.13"     : ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "udp_offload", \
                                     "iscsi_pdu_target", "iscsi_pdu_initiator", "vnic", "iwarp", \
                                     "sniffer", "tools", "benchmarks"],
                     "3.0.76"     : ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "udp_offload", \
                                     "iscsi_pdu_target", "iscsi_pdu_initiator", "vnic", "iwarp", \
                                     "sniffer", "tools","benchmarks"],
                     "3.0.101"     : ["bonding", "nic", "nic_offload", "toe", "udp_offload", \
                                     "iscsi_pdu_target", "iscsi_pdu_initiator", "vnic", "tools","benchmarks"],
                     "3.12.28-4"  : ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "udp_offload", \
                                     "iscsi_pdu_target", "iscsi_pdu_initiator", "vnic", "iwarp", \
                                     "sniffer", "tools","benchmarks"],
                     "3.12.49-11"  : ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "udp_offload", \
                                     "iscsi_pdu_target", "iscsi_pdu_initiator", "vnic", "iwarp", \
                                     "sniffer", "tools","benchmarks"],
                     "4.4.21-69"   : ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "udp_offload", \
                                     "iscsi_pdu_target", "iscsi_pdu_initiator", "vnic", "iwarp", \
                                     "sniffer", "tools","benchmarks"],
                     "4.4.73-5"   : ["bonding", "nic", "toe","wdtoe", "wdtoe_wdudp", "udp_offload", \
                                     "iscsi_pdu_initiator", "vnic", "iwarp", "iser", "nvme", "lio", "crypto", \
                                     "sniffer", "tools", "benchmarks"],
                     "4.12.14-94.41"   : ["bonding", "nic", "toe", \
                                     "iscsi_pdu_initiator", "vnic", "iwarp", "iser", "nvme", "lio", "crypto", \
                                     "tools", "benchmarks"],
                     "4.12.14-23"   : ["bonding", "nic", "toe",  \
                                     "iscsi_pdu_initiator", "vnic", "iwarp", "iser", "nvme", "lio", "crypto", \
                                     "sniffer", "tools", "benchmarks"],
                     "4.12.14-195"   : ["bonding", "nic", "toe", "udp_offload", \
                                     "iscsi_pdu_initiator", "vnic", "iwarp", "iser", "ovs", "nvme", "lio", "crypto", \
                                     "sniffer", "tools", "benchmarks"],
                     "2.6.32-71.el6"  : ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                      "sniffer", "tools","benchmarks"],
                     "2.6.32-131.0.15.el6"  : ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                      "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                      "sniffer", "tools","benchmarks"],
                     "2.6.32-220.el6"  : ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                      "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                      "sniffer", "tools","benchmarks"],
                     "2.6.32-279.el6"  : ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator",  \
                                      "sniffer", "tools","benchmarks"],
                     "2.6.32-358.el6"  : ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator",  \
                                      "sniffer", "tools","benchmarks"],
                     "2.6.32-431.el6"  : ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator",  \
                                      "sniffer", "tools","benchmarks"],
                     "2.6.32-504.el6"  : ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                      "sniffer", "tools","benchmarks"],
                     "2.6.32-573.el6"  : ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator",  \
                                      "sniffer", "tools","benchmarks"],
                     "2.6.32-642.el6"  : ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator",  \
                                      "sniffer", "tools","benchmarks"],
                     "2.6.32-696.el6"  : ["bonding", "nic", "nic_offload", "toe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator",  \
                                      "sniffer", "tools","benchmarks"],
                     "2.6.32-754.el6"  : ["bonding", "nic", "nic_offload", "toe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator",  \
                                      "sniffer", "tools","benchmarks"],
                     "3.0.101-63-default"  : ["bonding", "nic", "nic_offload", "toe", "udp_offload", \
                                     "iscsi_pdu_target", "iscsi_pdu_initiator", "vnic", "tools","benchmarks"],
                     "3.10.0-123.el7.x86_64"  : ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator",  \
                                      "sniffer", "tools","benchmarks"],
                     "3.10.0-229.el7.x86_64"  : ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator",  \
                                      "sniffer", "tools","benchmarks"],
                     "3.10.0-229.el7.ppc64"  : ["bonding", "nic", "nic_offload", "toe", "iwarp", "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                          "tools", "benchmarks"],
                     "3.10.0-229.ael7b.ppc64le"  : ["bonding", "nic", "nic_offload", "toe", "iwarp", "iscsi_pdu_target",  "iscsi_pdu_initiator", \
                                          "tools", "benchmarks"],
                     "3.10.0-327.el7.x86_64"  : ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator",  \
                                      "sniffer", "dpdk",  "tools","benchmarks"],
                     "3.10.0-327.el7.ppc64le"  : ["bonding", "nic", "nic_offload", "toe", "iwarp", "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                      "tools", "dpdk", "benchmarks"],
                     "3.10.0-514.el7.x86_64"  : ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
                                      "sniffer", "crypto", "dpdk", "ovs", "tools","benchmarks"],
                     "3.10.0-514.el7.ppc64le"  : ["bonding", "nic", "nic_offload", "toe", "iwarp", "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                          "tools", "dpdk", "benchmarks"],
                     "3.10.0-693.el7.x86_64"  : ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", "lio", \
                                       "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
                                      "sniffer", "crypto", "dpdk", "nvme", "iser", "ovs", "tools","benchmarks"],
                     "3.10.0-693.el7.ppc64le"  : ["bonding", "nic", "nic_offload", "toe", "iwarp",  "iscsi_pdu_initiator", "lio", \
                                          "tools", "benchmarks"],
                     "3.10.0-862.el7.x86_64"   : ["bonding", "nic", "nic_offload", "toe", "vnic", "iwarp", "udp_offload", "lio", \
                                       "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
                                      "sniffer", "crypto", "nvme", "iser", "ovs", "tools","benchmarks"],
                     "3.10.0-862.el7.ppc64le"  : ["bonding", "nic", "nic_offload", "toe", "iwarp",  "iscsi_pdu_initiator", "lio", \
                                          "tools", "benchmarks"],
                     "3.10.0-957.el7.x86_64"   : ["bonding", "nic", "nic_offload", "toe", "vnic", "iwarp", "udp_offload", "lio", \
                                       "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
                                      "sniffer", "crypto", "nvme", "iser", "ovs", "tools","benchmarks"],
                     "3.10.0-957.el7.ppc64le"  : ["bonding", "nic", "nic_offload", "toe", "iwarp",  "iscsi_pdu_initiator", "lio", \
                                          "tools", "benchmarks"],
                     "3.10.0-1062.el7.x86_64"   : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", "lio", \
                                       "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
                                      "sniffer", "crypto", "nvme", "iser", "ovs", "tools","benchmarks"],
                     "3.10.0-1127.el7.x86_64"   : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                       "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
                                      "sniffer", "crypto", "nvme", "iser", "ovs", "tools","benchmarks", "nvme_toe_spdk", "lio"],
                     "3.10.0-1160.el7.x86_64"   : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                       "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
                                      "sniffer", "crypto", "nvme", "iser", "ovs", "tools","benchmarks", "nvme_toe_spdk", "lio"],
                     "4.18.0-80.el8.x86_64"   : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", "lio", \
                                       "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
                                       "sniffer", "crypto", "nvme", "iser", "tools","benchmarks"],
                     "4.18.0-147.el8.x86_64"   : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", "lio", \
                                       "iscsi_pdu_initiator",  \
                                       "sniffer", "crypto", "nvme", "iser", "tools","benchmarks"],
                     "4.18.0-193.el8.x86_64"   : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                       "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
                                       "sniffer", "crypto", "nvme", "iser", "tools","benchmarks", "nvme_toe_spdk", "lio"],
                     "4.18.0-240.el8.x86_64"   : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                       "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
                                       "sniffer", "crypto", "nvme", "iser", "tools","benchmarks", "nvme_toe", "nvme_toe_spdk", "lio"],
		     "4.2.0-27"     : ["bonding", "nic", "nic_offload", "toe", "wdtoe_wdudp", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_target", "iscsi_pdu_initiator",  \
                                        "sniffer", "tools", "benchmarks"],
		     "4.4.0-21-generic"     : ["bonding", "nic", "nic_offload", "toe", "wdtoe_wdudp", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_target", "iscsi_pdu_initiator",  \
                                        "sniffer", "tools"],
                     "4.4.0-31-generic"     : ["bonding", "nic", "nic_offload", "toe", "wdtoe_wdudp", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_target", "iscsi_pdu_initiator",  \
                                        "sniffer", "crypto", "tools"],
                     "4.4.0-116-generic"     : ["bonding", "nic", "nic_offload", "toe", "wdtoe_wdudp", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_target",  "iscsi_pdu_initiator",  \
                                        "sniffer", "crypto", "tools"],
                     "4.4.0-131-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_target", "iscsi_pdu_initiator",  \
                                        "sniffer", "crypto", "tools"],
                     "4.4.0-142-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_target",  "iscsi_pdu_initiator",  \
                                        "sniffer", "crypto", "tools", "benchmarks"],
                     "4.15.0-29-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools", "benchmarks"],
                     "4.15.0-45-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", \
                                        "iscsi_pdu_initiator","lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools", "benchmarks"],
                     "4.15.0-55-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", \
                                        "iscsi_pdu_initiator","lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools", "benchmarks"],
                     "4.15.0-76-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator","lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools", "benchmarks"],
                     "4.15.0-126-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools", "benchmarks"],
                     "5.4.0-26-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools", "benchmarks", "nvme_toe", "nvme_toe_spdk", "lio"],
                     "5.4.0-54-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools", "benchmarks", "nvme_toe", "nvme_toe_spdk", "lio"],
                     "5.4.0-65-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools", "benchmarks", "nvme_toe", "nvme_toe_spdk", "lio"],
                     "3.4"      : ["bonding", "nic", "nic_offload", "toe",  "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", \
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                   "sniffer", "tools", "udp_offload","benchmarks"],
                     "3.6"	: ["bonding", "nic", "nic_offload", "toe",  "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", \
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                   "sniffer", "fcoe_pdu_offload_target", "tools", "udp_offload","benchmarks"],
                     "3.7"	: ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp",  \
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", "sniffer", \
                                   "tools", "udp_offload","benchmarks"],
                     "3.8"      : ["bonding", "nic", "nic_offload", "toe", "vnic", "iwarp", "iscsi_pdu_target", "iscsi_pdu_initiator",  "tools", \
                                   "udp_offload", "benchmarks"],
                     "3.9"      : ["nic", "nic_offload", "toe", "iwarp", "iscsi_pdu_target",  "iscsi_pdu_initiator",  "tools","benchmarks"],
                     "3.10"      : ["nic", "nic_offload", "toe", "iwarp", "iscsi_pdu_target",  "iscsi_pdu_initiator",  "tools","benchmarks"],
                     "3.11"      : ["nic", "nic_offload", "toe", "iwarp", "iscsi_pdu_target",  "iscsi_pdu_initiator",  "tools","benchmarks"],
                     "3.12"      : ["nic", "nic_offload", "toe", "iwarp", "iscsi_pdu_target",  "iscsi_pdu_initiator",  "tools","benchmarks"],
                     "3.13"      : ["nic", "nic_offload", "toe", "iwarp", "iscsi_pdu_target",  "iscsi_pdu_initiator",  \
                                    "tools","benchmarks"],
                     "3.14"      : ["bonding", "nic", "nic_offload", "toe", "iwarp", "iscsi_pdu_target",  "iscsi_pdu_initiator",  "lio", \
                                    "tools","benchmarks"],
                     "3.16"	: ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", \
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                   "sniffer", "tools", "udp_offload","benchmarks"],
                     "3.17"	: ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp","vnic", "iwarp", \
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                   "sniffer", "tools", "udp_offload","benchmarks"],
                     "3.18"	: ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp","vnic", "iwarp", \
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                   "sniffer", "tools", "udp_offload","benchmarks"],
                     "4.1"	: ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp","vnic", "iwarp", \
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                   "sniffer", "tools", "udp_offload","benchmarks"],
                     "4.4"	: ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp","vnic", "iwarp",  \
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                   "sniffer", "tools", "udp_offload","benchmarks"],
                     "4.5"	: ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp","vnic", "iwarp",  \
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                   "crypto", "sniffer", "tools", "udp_offload","benchmarks"],
                     "4.8"	: ["bonding", "nic", "nic_offload", "toe", "wdtoe", "wdtoe_wdudp","vnic", "iwarp",\
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                   "sniffer", "nvme", "lio", "iser", "crypto", "tools", "udp_offload","benchmarks"],
                     "4.9"	: ["bonding", "nic", "nic_offload", "toe", "wdtoe_wdudp","vnic", "iwarp",\
                                   "iscsi_pdu_initiator", \
                                   "sniffer", "nvme", "lio", "iser", "crypto", "tools", "udp_offload", "ovs", "benchmarks"],
                     "4.14"	: ["bonding", "nic", "nic_offload", "toe", "udp_offload", "vnic", "iwarp", "iscsi_pdu_initiator", "sniffer", "nvme", "lio", "iser", "crypto", "tools", "benchmarks"],
                     "4.19"	: ["bonding", "nic", "nic_offload", "toe", "udp_offload", "vnic", "iwarp", "iscsi_pdu_initiator", "sniffer", "nvme", "lio", "iser", "crypto", "tools", "benchmarks"],
                     "5.4"	: ["bonding", "nic", "nic_offload", "toe", "udp_offload", "vnic", "iwarp", "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "sniffer", "nvme", "iser", "crypto", "tools", "benchmarks", "nvme_toe", "nvme_toe_spdk", "lio"],
                     "5.0"	: ["nic", "nic_offload", "toe", "tools", "benchmarks"],
                     "5.2"	: ["nic", "nic_offload", "toe", "tools", "benchmarks"],
                     "5.6"	: ["bonding", "nic", "nic_offload", "toe", "tools", "benchmarks"],
                     "5.10"	: ["bonding", "nic", "nic_offload", "toe", "udp_offload", "vnic", "iwarp", "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "sniffer", "nvme", "iser", "crypto", "tools", "benchmarks", "nvme_toe", "nvme_toe_spdk", "lio"]
		}
    ofedsupportMatrix = dict.fromkeys(["2.6.32-431", "2.6.32-504", "2.6.32-573", "2.6.32-642", \
                                            "3.10.0-123", "3.10.0-229", "3.10.0-327", \
                                            "3.0.76", "3.12.28-4", "3.12.49-11", "3.18"],['3.18-3'])
    ofedsupportMatrix.update(dict.fromkeys(["3.10.0-123", "3.10.0-210", "3.10.0-327", "3.10.0-514", "3.12.28-4", "3.12.49-11", "4.4.21-69"], ['4.8-1']))
    ofedsupportMatrix.update(dict.fromkeys(["3.10.0-123", "3.10.0-210", "3.10.0-327", "3.10.0-514", "3.10.0-693", "3.12.28-4", "3.12.49-11", "4.4.21-69", "4.4.73-5"], ['4.8-2']))
    installofed = False 
    def __init__(self):
        pass
	...
	pas=False
		...
		self.kvr = ver ;
		    ...
		    if not ver in ["3.12.49-11", "3.12.28-4", "3.0.13", "3.0.76", "3.0.101", "4.4.21-69", "4.4.73-5", "4.12.14-94.41", "4.12.14-23", "4.12.14-195"] :
	                pas=False
		    else:
			break
                if kversion.find("el7") != -1 :
		    if ver not in ["3.10.0-123.el7.x86_64", "3.10.0-123.el7.ppc64", "3.10.0-123.ael7b.ppc64le", \
				   "3.10.0-229.el7.x86_64", "3.10.0-229.el7.ppc64", "3.10.0-229.ael7b.ppc64le", \
				   "3.10.0-327.el7.x86_64", "3.10.0-514.el7", "3.10.0-514.el7.x86_64", "3.10.0-514.el7.ppc64le", \
				   "3.10.0-693.el7", "3.10.0-693.el7.x86_64", "3.10.0-693.el7.ppc64le", \
                                   "3.10.0-862.el7", "3.10.0-862.el7.x86_64", "3.10.0-862.el7.ppc64le", \
                                   "3.10.0-957.el7", "3.10.0-957.el7.x86_64", "3.10.0-957.el7.ppc64le", \
                                   "3.10.0-1062.el7", "3.10.0-1062.el7.x86_64", \
                                   "3.10.0-1127.el7", "3.10.0-1127.el7.x86_64",\
                                   "3.10.0-1160.el7", "3.10.0-1160.el7.x86_64"]:
                        pas=False
		    else:
	                break
                if kversion.find("el8") != -1 :
		    if ver not in ["4.18.0-80.el8.x86_64", "4.18.0-80.el8", "4.18.0-147.el8.x86_64", "4.18.0-147.el8", "4.18.0-193.el8.x86_64", "4.18.0-193.el8", "4.18.0-240.el8.x86_64", "4.18.0-240.el8"]:
                        pas=False
		    else:
	                break
                if kversion.find("generic") != -1:
		    if not ver in ["5.4.0-26-generic", "5.4.0-54-generic", "5.4.0-65-generic", "4.15.0-76-generic", "4.15.0-126-generic", "4.15.0-55-generic", "4.15.0-45-generic", "4.15.0-29-generic", "4.4.0-116-generic", "4.4.0-131-generic", "4.4.0-142-generic"] :
                        pas=False
                    else:
                        break
        if not pas :
	...
	supportedTarget = []
	if platform.processor().find("ppc64") == -1 and platform.processor().find("aarch64") == -1 :
		wdstr = [ "& WD-UDP libraries",", WD-UDP"]
		copstr = "cop, "
	else :
		wdstr = ["", ""]
		copstr = ""
	comp = [("nic","Chelsio Network Driver   ( Non-offload disables all offload support- cxgb4 ) ",0),
                ("nic_offload","Chelsio Network Driver   ( Offload - cxgb4 ) ",0),
                ...
                ("iwarp","Chelsio iWARP Driver "+ wdstr[0] +"   ( offload - iw_cxgb4"+ wdstr[1] +" ) ",0),
                ...
                ("nvme","Chelsio iWARP Driver & NVMe Utilities ",0),
                ("nvme_toe","Chelsio iWARP Driver, t4_tom driver & NVMe Utilities ",0),
                ("nvme_toe_spdk","SPDK NVMe/TOE driver, SPDK & NVMe Utilities ",0),
                ("lio","Chelsio LIO Target Driver & Utilities ",0),
                ("iser","Chelsio iWARP Driver, iser library & Utilities ",0),
                ("crypto","Chelsio Crypto Driver & Openssl modules  ",0),
                ("dpdk","Chelsio DPDK modules, pktgen. library & NIC offload driver ",0),
                ("ovs","OVS modules & NIC offload driver ",0),
                ("tools","Chelsio user utilities   ( cxgbtool, "+copstr+"etc )",0),
                ("benchmarks", "Benchmark tools",0),
                ("libs", "Chelsio libs             ( libcxgb4,libcxbg4_sock )",0)]
        sort = sorted(self.supportMatrix.keys(),reverse=True)
        for ix in range(0, len(self.supportMatrix.keys())):
            if kversion.find(sort[ix], 0, len(sort[ix])) != -1 :
	...
	if self.uninstall:
	    ...
	    return
	if self.configTune == "Balanced Uwire" or self.configTune == "Ring Backbone":
	    self.components = customTarget
	    toRemove = [ "udp_offload", "nic_offload", "wdtoe_wdudp", "fcoe_pdu_offload_target", "crypto", "ovs", "dpdk", "nvme_toe"]
	    if self.configTune == "Ring Backbone":
	        toRemove.append("fcoe_full_offload_initiator")
	    for i in toRemove:
                if i in self.components:
                    self.components.remove(i)
	elif self.configTune == "Low latency Networking" : 
	    self.components = customTarget
	    toRemove = [ "nic", "vnic", "iscsi_pdu_target", "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
	    "fcoe_pdu_offload_target", "udp_offload","wdtoe_wdudp", "sniffer", "nvme", "lio", "iser", "crypto", "dpdk", "ovs", "nvme_toe", "nvme_toe_spdk"]
	    if kversion.find('2.6.35') != -1 or kversion.find("3.2.0-23") != -1 or  kversion.find("3.5.0-23") != -1:
		toRemove.remove("toe") 
	    for i in toRemove:
                if i in self.components:
                    self.components.remove(i)
            if "nic_offload" not in self.components :
                self.components.append("nic_offload")
	elif self.configTune == "T5 No External Memory" or self.configTune == "High Capacity WD" :
            self.components = customTarget
            toRemove = [ "nic", "vnic", "bonding", "iscsi_pdu_target", "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "fcoe_pdu_offload_target",\
                         "udp_offload","wdtoe_wdudp", "sniffer", "nvme", "lio", "iser", "crypto", "dpdk", "ovs", "nvme_toe", "nvme_toe_spdk"]
	    if self.configTune == "High Capacity WD" :
	        toRemove.append("toe")
	    '''if self.configTune == "High Capacity WD" :
	        toRemove.append("toe")
	        toRemove.remove("wdtoe")
            if kversion.find('2.6.35') != -1 or kversion.find("3.2.0-23") != -1 or  kversion.find("3.5.0-23") != -1 :
                toRemove.remove("toe")'''
            for i in toRemove:
                if i in self.components:
	    ...
	    self.components = customTarget
            toRemove = [ "nic", "toe", "wdtoe", "bonding", "sniffer", "vnic", "iscsi_pdu_target", "iscsi_pdu_initiator", "fcoe_full_offload_initiator","fcoe_pdu_offload_target", \
                         "udp_offload","wdtoe_wdudp", "nvme", "lio", "iser", "crypto", "dpdk", "ovs", "nvme_toe", "nvme_toe_spdk"]
            for i in toRemove:
                if i in self.components:
                    self.components.remove(i)
	elif self.configTune == "RDMA Performance" or self.configTune == "NVME Performance":
            self.components = customTarget
            toRemove = [ "nic", "toe", "wdtoe", "vnic", "bonding", "sniffer", "iscsi_pdu_target",  "iscsi_pdu_initiator", \
                         "fcoe_full_offload_initiator", "fcoe_pdu_offload_target", "udp_offload","wdtoe_wdudp", "lio", "crypto", \
                         "dpdk", "ovs", "nvme_toe"]
            if self.configTune == "NVME Performance":
                toRemove.append("iser")
            if self.configTune == "RDMA Performance":
                toRemove.append("nvme_toe_spdk")
            for i in toRemove:
                if i in self.components:
                    self.components.remove(i)
	elif self.configTune == "Memory Free":
            self.components = customTarget
            toRemove = [ "nic", "wdtoe", "vnic", "bonding", "sniffer", "iscsi_pdu_target",  "iscsi_pdu_initiator", \
                         "fcoe_full_offload_initiator", "fcoe_pdu_offload_target", "udp_offload","wdtoe_wdudp", \
                         "rdma_block_device", "nvme", "lio", "iser", "crypto", "dpdk", "ovs", "nvme_toe", "nvme_toe_spdk"]
            for i in toRemove:
                if i in self.components:
                    self.components.remove(i)
	elif self.configTune == "High capacity TOE":
	    self.components = customTarget
	    toRemove = [ "nic", "vnic", "iscsi_pdu_target",  "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "fcoe_pdu_offload_target", \
			 "iwarp", "libs",  "sniffer", "udp_offload","wdtoe_wdudp", \
			 "rdma_block_device", "nvme", "lio", "iser", "crypto", "dpdk", "ovs", "nvme_toe", "nvme_toe_spdk"]
	    for i in toRemove:
                if i in self.components:
                    self.components.remove(i)
	elif self.configTune == "High Capacity Hash Filter" :
	    self.components = ["nic_offload", "tools"]
	elif self.configTune == "High Capacity VF" :
	    self.components = ["nic", "vnic", "tools"]
	elif self.configTune == "UDP Seg. Offload & Pacing":
	    self.components = [ "udp_offload", "bonding", "tools" ]
	elif self.configTune == "iSCSI Performance" :
	    self.components = customTarget
	    #print "customTarget : ",customTarget
	    if kversion.find("4.18.0-240.el8") != -1 or  kversion.find("4.18.0-193.el8") != -1 or kversion.find("4.18.0-147.el8") != -1 or kversion.find("4.18.0-80.el8") != -1 or kversion.find("3.10.0-1127.el7") != -1 or kversion.find("3.10.0-1160.el7") != -1 or kversion.find("3.10.0-1062.el7") != -1 or kversion.find("3.10.0-957.el7") != -1 or kversion.find("3.10.0-862.el7") != -1 or platform.processor().find("ppc64") != -1 or \
                kversion.find("4.9") != -1 or kversion.find("4.14") != -1 or kversion.find("4.19") != -1 or kversion.find("5.4") != -1 or kversion.find("5.6") != -1 or kversion.find("5.10") != -1 or kversion.find("4.4.73-5") != -1 or  kversion.find("4.12.14-94.41") != -1 or  kversion.find("4.12.14-23") != -1 or  kversion.find("4.12.14-195") != -1  or  kversion.find("4.15.0-29-generic") != -1 or  kversion.find("4.15.0-55-generic") != -1 or kversion.find("4.15.0-76-generic") != -1 or kversion.find("4.15.0-126-generic") != -1 or kversion.find("5.4.0-26-generic") != -1 or kversion.find("5.4.0-54-generic") != -1 or kversion.find("5.4.0-65-generic") != -1 :
	    		toRemove = [ "nic", "vnic", "toe", "bonding", "wdtoe","vnic", "fcoe_full_offload_initiator", "fcoe_pdu_offload_target", "iwarp", \
                         "libs", "sniffer", "udp_offload","wdtoe_wdudp", "rdma_block_device", "nvme", "iser", "crypto", \
	                 "dpdk", "ovs", "nvme_toe", "nvme_toe_spdk"]
	    else:		
	...
	if kversion.find('2.6.16.60-0.21') == -1:
		if self.configTune == "Low latency Networking" or self.configTune == "T5 No External Memory" \
			...
			toRemove = [ "bypass","toe_ipv4", "libs", "nic_offload", "wdtoe","wdtoe_wdudp"]
		else:
	...
	if self.uninstall:
	    toremove = []
            ...
            for ix in toremove:
                del(allComp[ix])
	    return allComp
	if self.configTune == "Balanced Uwire" or self.configTune == None or self.configTune == "Ring Backbone" :
	    toremove = []
	    for i in range(0, len(allComp)):
		if allComp[i][0].find('udp_offload') != -1 or \
                   allComp[i][0].find('nic_offload') != -1 or \
                   allComp[i][0].find('ovs') != -1 :
		    toremove.append(i)
		if platform.processor().find('aarch64') != -1:
			if allComp[i][0].find('vnic') != -1 or \
			   allComp[i][0].find('wdtoe') != -1 or \
			   allComp[i][0].find('wdtoe_wdudp') != -1 or \
			   allComp[i][0].find('sniffer') != -1 :
				toremove.append(i)
	    ...
	    for i in range(0, len(allComp)):
		   ...
		   allComp[i][0].find('nic') != -1 or \
                   allComp[i][0].find('nvme') != -1 or \
                   allComp[i][0].find('nvme_toe') != -1 or \
                   allComp[i][0].find('nvme_toe_spdk') != -1 or \
                   allComp[i][0].find('lio') != -1 or \
                   allComp[i][0].find('iser') != -1 or \
                   allComp[i][0].find('crypto') != -1 or \
                   allComp[i][0].find('dpdk') != -1 or \
                   allComp[i][0].find('ovs') != -1 or \
		   allComp[i][0].find('vnic') != -1:
		   toremove.append(i)
	        if self.configTune == "High capacity RDMA" :
                   if allComp[i][0].find('wdtoe') != -1 or \
                      allComp[i][0].find('bonding') != -1 or \
                      allComp[i][0].find('toe') != -1 :
                      toremove.append(i)
		'''if platform.processor().find('aarch64') != -1:
			if allComp[i][0].find('wdtoe_wdudp') != -1:
				toremove.append(i)
			if self.configTune == "Low latency Networking" :
	    ...
	    return allComp
             ...
             self.configTune == "Memory Free" or self.configTune == "NVME Performance" :
            toremove = []
            for i in range(0, len(allComp)):
                if allComp[i][0].find('fcoe_full_offload') != -1 or \
                   allComp[i][0].find('fcoe_pdu_offload') != -1 or \
		   ...
		   if allComp[i][0].find('nvme') != -1 or allComp[i][0].find('nvme_toe') != -1 or allComp[i][0].find('nvme_toe_spdk') != -1:
                      toremove.append(i)
                if self.configTune == "RDMA Performance":
		   if allComp[i][0] == 'toe' or allComp[i][0].find('nvme_toe') != -1 or allComp[i][0].find('nvme_toe_spdk') != -1:
                      toremove.append(i)
                if self.configTune == "NVME Performance" :
		   if allComp[i][0] == 'toe' or allComp[i][0] == 'nvme_toe':
                      toremove.append(i)
                if self.configTune == "NVME Performance" :
		   if allComp[i][0].find('iser') != -1 :
                      toremove.append(i)
		'''if platform.processor().find('aarch64') != -1:
			if allComp[i][0].find('wdtoe') != -1 or \
			   allComp[i][0].find('wdtoe_wdudp') != -1 :
				toremove.append(i)'''
            toremove.sort(cmp=None, key=None, reverse=True)
            for ix in toremove:
                del(allComp[ix])
            return allComp
             ...
             self.configTune == "High Capacity WD" : 
            toremove = []
            for i in range(0, len(allComp)):
                if allComp[i][0].find('fcoe_full_offload') != -1 or \
                   allComp[i][0].find('fcoe_pdu_offload') != -1 or \
	    ...
	    for i in range(0, len(allComp)):
		   ...
		   allComp[i][0].find('vnic') != -1:
		   toremove.append(i)
		if self.configTune != "iSCSI Performance" :
                   if allComp[i][0].find('lio') != -1 :
                       toremove.append(i)
		if self.configTune == "iSCSI Performance" :
			kversion = platform.release()
	    		if kversion.find("4.18.0-240.el8") != -1 or kversion.find("4.18.0-193.el8") != -1 or  kversion.find("4.18.0-147.el8") != -1 or  kversion.find("4.18.0-80.el8") != -1 or kversion.find("3.10.0-1127.el7") != -1 or kversion.find("3.10.0-1160.el7") != -1 or kversion.find("3.10.0-1062.el7") != -1 or kversion.find("3.10.0-957.el7") != -1 or kversion.find("3.10.0-862.el7") != -1 or platform.processor().find("ppc64") != -1 or \
                            kversion.find("4.9") != -1 or kversion.find("4.14") != -1 or kversion.find("4.19") != -1 or kversion.find("5.4") != -1 or kversion.find("5.6") != -1 or kversion.find("5.10") != -1 or  kversion.find("4.4.73-5") != -1 or  kversion.find("4.12.14-94.41") != -1 or  kversion.find("4.12.14-23") != -1 or  kversion.find("4.12.14-195") or  kversion.find("4.15.0-29-generic") != -1 or  kversion.find("4.15.0-55-generic") != -1 or kversion.find("4.15.0-76-generic") != -1 or kversion.find("4.15.0-126-generic") != -1 or kversion.find("5.4.0-26-generic") != -1 or kversion.find("5.4.0-54-generic") != -1 or kversion.find("5.4.0-65-generic") != -1 :
                   		if allComp[i][0].find('toe') != -1 or allComp[i][0].find('bonding') != -1:
                       			toremove.append(i)
		...
		'''if platform.processor().find('aarch64') != -1:
			if allComp[i][0].find('wdtoe_wdudp') != -1 : 
				toremove.append(i)'''
	    res = [] 
	    [res.append(x) for x in toremove if x not in res]
	    toremove = res	
	    toremove.sort(cmp=None, key=None, reverse=True)
	    for ix in toremove:
		del(allComp[ix])
	    ...
	    toremove = []
            for i in range(0, len(allComp)):
                if allComp[i][0].find('nic') != 0  and \
                   allComp[i][0].find('vnic') != 0 and \
                   allComp[i][0].find('tools') != 0 and \
                   allComp[i][0].find('benchmarks') != 0 :
                   toremove.append(i)
                if allComp[i][0].find('nic_offload') != -1 :
                   toremove.append(i)
            toremove.sort(cmp=None, key=None, reverse=True)
            for ix in toremove:
                del(allComp[ix])
	    ...
	    toremove = []
            for i in range(0, len(allComp)):
                if allComp[i][0].find('udp_offload') != 0  and \
                   allComp[i][0].find('bonding') != 0 and \
                   allComp[i][0].find('tools') != 0 and \
                   allComp[i][0].find('benchmarks') != 0 :
                   toremove.append(i)
            toremove.sort(cmp=None, key=None, reverse=True)
	...
	ofedVersionList = ["3.18-3", "4.8-1", "4.8-2"]
	ch=1
	choices=[]
	...
	if ret == None :
            ...
            return ret
	elif (( ret == 0 ) and ( tag in ["OFED-3.18-3"])):
            self.ofed_fversion = "3.18-3"
	elif (( ret == 0 ) and ( tag in ["OFED-4.8-1"])):
            self.ofed_fversion = "4.8-1"
	elif (( ret == 0 ) and ( tag in ["OFED-4.8-2"])):
            self.ofed_fversion = "4.8-2"
    ...
    def promptUninstall(self,a,texts="Choose an action"):
	    ...
	    return ret
		    ...
		    return D_BACK
                ret = self.promptAllCustom(a, texts="Choose uninstall components")
            compstruct1 = ["iscsi_pdu_target", "iscsi_pdu_initiator", "fcoe_pdu_offload_target", "fcoe_full_offload_initiator", \
                           "sniffer", "wdtoe_wdudp", "nvme", "lio", "iser", "iwarp", "bypass", "wdtoe", "dpdk", "ovs", \
                           "bonding", "crypto", "toe", "udp_offload", "nic", "vnic", "tools", "all"]
            compstruct2 = []
	...
	if self.uninstall :
             ...
             '''if self.configTune == "Hash Filter" :
                 (code,tag) = a.radiolist(
                     text=texts,
                     width=100,
	...
	os_name = os.uname()[1][5:9]
	if os_name == "sles":
		if inst > 0 :
		     code,tags = a.form("Wrong path provided. Please provide the correct path to kernel source\nPress \"Skip\" to continue installation and the installer will install kernel source(kernel-devel) using Package Manager.",
				      elements,
				      width = 110, height = 10, cancel="Skip")
		else:
			     code,tags = a.form("Please provide the path to kernel source. \nPress \"Skip\" to continue installation and the installer will install kernel source(kernel-devel) using Package Manager.",
					      elements,
				      width = 90, height = 10, cancel="Skip")
	else:
    ...
    def promptTunnables(self,a,texts="Select the Performance Tuning"):
		...
		if "Enable Binding IRQs to CPUs" not in self.tunnables and "Disable-affinity" not in self.tunnables :
		    self.tunnables.append('Disable-affinity')
            if not ( self.configTune in [ "UDP Seg. Offload & Pacing", "High capacity TOE", "iSCSI Performance", "High Capacity Hash Filter"] ) :
	        kver = self.kernel_ver
		#print self.components
		if "iwarp" in self.components or "wdtoe_wdudp" in self.components or "sniffer" in self.components:
		        ...
		        if kver.find(ver) != -1 :
		            ...
		            break
	    if setkpath :
	        self.kpaths=self.promptKernelSource(a,0)
	        #print self.kpaths

    def promptConfigTune(self, a,texts="Select the Terminator Configuration tuning"):
	choice_arr = [ ("Unified Wire","Configures to run all protocols simultaneously(Default)",1)]
	customTarget = []
	kversion = self.kernel_ver
        sort = sorted(self.supportMatrix.keys(),reverse=True)
        for ix in range(0, len(self.supportMatrix.keys())):
	...
	if kversion.find("4.15.0") != -1 or kversion.find("5.0") == -1:
		print "kversion :",kversion
		if "iwarp" in customTarget:
		    choice_arr.append(("Low latency Networking","Configures Low Latency TOE,iWARP",0))
		    choice_arr.append(("High capacity RDMA","Configures large number of iWARP connections",0))
		    choice_arr.append(("RDMA Performance","iWARP performance optimized configuration",0))
		    if kversion.find("2.6.32-754.el6.x86_64") == -1 and kversion.find("2.6.32-696.el6.x86_64") == -1 and kversion.find("4.4.21-69") == -1 and kversion.find("3.0.101") == -1 and kversion.find("4.4.0-142-generic") == -1 :
			if platform.processor().find("ppc64") == -1:
				choice_arr.append(("NVMe Performance","NVMe performance optimized configuration",0))
		else:
		    choice_arr.append(("Low latency Networking","Configures Low Latency TOE",0))
		if "toe" in customTarget:
		    choice_arr.append(("High capacity TOE","Configures large number of TOE connections",0))
		if "iscsi_pdu_target" in customTarget or "iscsi_pdu_initiator" in customTarget :
		    choice_arr.append(("iSCSI Performance","iSCSI performance optimized configuration",0))
		if platform.processor().find("ppc64") == -1 and platform.processor().find("aarch64") == -1 :
		    if "udp_offload" in customTarget:
			choice_arr.append(("UDP Seg. Offload & Pacing","Configures large number of UDP offload connections",0))
		    if "iwarp" in customTarget:
			choice_arr.append(("Wire Direct Latency","Configures Low Latency WireDirect",0))
			choice_arr.append(("High Capacity WD","Configures large number of WD connections",0))
		if kversion.find("5.6") == -1 and platform.processor().find('ppc64') == -1 and platform.processor().find('aarch64') == -1 :
			choice_arr.append(("High Capacity VF", "Configures large number of Virtual Functions",0))
		if kversion.find("5.6") == -1 :
			choice_arr.append(("High Capacity Hash Filter", "Configures large number of filters",0))
		#choice_arr.append(("Ring Backbone", "For Ring configuration",0))
	#if "iwarp" in customTarget:
	#    choice_arr.append(("Memory Free","Configures TOE,iWARP offload in Memory-free mode",0))
	...
	if self.configTune.find("Unified Wire") != -1 :
        ...
        elif self.configTune.find("Wire Direct Latency") != -1 :
            self.configTune = "T5 No External Memory"
        elif self.configTune.find("High Capacity WD") != -1 :
            self.configTune = "High Capacity WD"
        elif self.configTune.find("High Capacity VF") != -1 :
            self.configTune = "High Capacity VF"
        elif self.configTune.find("High Capacity Hash Filter") != -1 :
            self.configTune = "High Capacity Hash Filter"
	elif self.configTune.find("RDMA Performance") != -1 :
	    self.configTune = "RDMA Performance"
	elif self.configTune.find("NVMe Performance") != -1 :
	    self.configTune = "NVME Performance"
	...
	elif self.configTune.find("Ring Backbone") != -1 :
	    self.configTune = "Ring Backbone"
	...
	OSKerMat = { "RHEL6.X"          : "2.6.32-642.el6",
		     "RHEL7.X"          : "3.10.0-327.el7",
		     "RHEL7.3"          : "3.10.0-514.el7",
		     "RHEL7.4"          : "3.10.0-693.el7",
                     "RHEL7.5"          : "3.10.0-862.el7",
                     "RHEL7.6"          : "3.10.0-957.el7",
                     "RHEL7.7"          : "3.10.0-1062.el7",
                     "RHEL7.8"          : "3.10.0-1127.el7",
                     "RHEL7.9"          : "3.10.0-1160.el7",
		     ...
		     "SLES12SP2"        : "4.4.21-69",
		     "SLES12SP3"        : "4.4.73-5",
		     "SLES12SP4"        : "4.12.14-94.41",
		     "SLES15"           : "4.12.14-23",
		     "SLES15SP1"        : "4.12.14-195",
		     "ubuntu-14.04.3"   : "3.19.0-25",
		     "ubuntu-14.04.4"   : "4.2.0-27",
	...
	supportMatrix = [ ("2.6.32-279.el6","Red Hat Enterprise Linux Server release 6.3",0),
				      ...
				      ("2.6.32-642.el6","Red Hat Enterprise Linux Server release 6.8",0),
				      ("2.6.32-696.el6","Red Hat Enterprise Linux Server release 6.9",0),
				      ("2.6.32-754.el6","Red Hat Enterprise Linux Server release 6.10",0),
				      ...
				      ("3.10.0-514.el7","Red Hat Enterprise Linux Server release 7.3",0),
                                      ("3.10.0-693.el7","Red Hat Enterprise Linux Server release 7.4",0),
                                      ("3.10.0-862.el7","Red Hat Enterprise Linux Server release 7.5",0),
                                      ("3.10.0-957.el7","Red Hat Enterprise Linux Server release 7.6",0),
                                      ("3.10.0-1062.el7","Red Hat Enterprise Linux Server release 7.7",0),
                                      ("3.10.0-1127.el7","Red Hat Enterprise Linux Server release 7.8",0),
                                      ("3.10.0-1160.el7","Red Hat Enterprise Linux Server release 7.9",0),
                                      ("4.18.0-80.el8","Red Hat Enterprise Linux Server release 8.0",0),
                                      ("4.18.0-147.el8","Red Hat Enterprise Linux Server release 8.1",0),
                                      ("4.18.0-193.el8","Red Hat Enterprise Linux Server release 8.2",0),
                                      ("4.18.0-240.el8","Red Hat Enterprise Linux Server release 8.3",0),
				      ...
				      ("4.4.21-69","SUSE Linux Enterprise Server 12 SP2",0), 
				      ("4.4.73-5","SUSE Linux Enterprise Server 12 SP3",0), 
				      ("4.12.14-94.41","SUSE Linux Enterprise Server 12 SP4",0),
				      ("4.12.14-23","SUSE Linux Enterprise Server 15",0), 
				      ("4.12.14-195","SUSE Linux Enterprise Server 15 SP1",0), 
				      ("3.13.0-32","Ubuntu 14.04.1 LTS",0),
				      ("3.16.0-30","Ubuntu 14.04.2 LTS",0),
				      ("3.19.0-25","Ubuntu 14.04.3 LTS",0),
				      ("4.2.0-27","Ubuntu 14.04.4 LTS",0),
				      ("4.4.0-21-generic","Ubuntu 16.04 LTS",0),
				      ("4.4.0-31-generic","Ubuntu 16.04.1 LTS",0),
                                      ("4.4.0-116-generic","Ubuntu 16.04.4 LTS",0),
                                      ("4.4.0-131-generic","Ubuntu 16.04.5 LTS",0),
                                      ("4.4.0-142-generic","Ubuntu 16.04.6 LTS",0),
				      ("4.15.0-29-generic","Ubuntu 18.04.1 LTS",0),
				      ("4.15.0-55-generic","Ubuntu 18.04.3 LTS",0),
				      ("4.15.0-76-generic","Ubuntu 18.04.4 LTS",0),
				      ("4.15.0-126-generic","Ubuntu 18.04.5 LTS",0),
				      ("5.4.0-26-generic","Ubuntu 20.04 LTS",0),
				      ("5.4.0-54-generic","Ubuntu 20.04.1 LTS",0),
				      ("5.4.0-65-generic","Ubuntu 20.04.2 LTS",0),
				      ...
				      ("4.2","Linux kernel Release",0),
				      ("4.4","Linux kernel Release",0),
				      ("4.5","Linux kernel Release",0),
				      ("4.8","Linux kernel Release",0),
				      ("4.9","Linux kernel Release",0),
				      ("4.14","Linux kernel Release",0),
				      ("4.19","Linux kernel Release",0),
				      ("5.0","Linux kernel Release",0),
				      ("5.2","Linux kernel Release",0),
				      ("5.6","Linux kernel Release",0),
				      ("5.4","Linux kernel Release",0),
				      ("5.10","Linux kernel Release",0) ]

	for i in range(len(supportMatrix)):
		if supportMatrix[i][0].find(upkver) > 0 :
			fkver = upkver
			break
	else:
		sles12sp4_check = os.uname()[1]
		if upkver.find("el6") != -1 and int(upkver.split("-")[1].split(".")[0]) > 279:
			fkver = OSKerMat["RHEL6.X"] #+ "." + proc
		elif upkver.find("el7") != -1 and int(upkver.split("-")[1].split(".")[0]) > 123 and int(upkver.split("-")[1].split(".")[0]) < 514 :
			fkver = OSKerMat["RHEL7.X"] #+ "." + proc
		elif upkver.find("el7") != -1 and int(upkver.split("-")[1].split(".")[0]) >= 514 and int(upkver.split("-")[1].split(".")[0]) < 693:
			fkver = OSKerMat["RHEL7.3"] #+ "." + proc
		elif upkver.find("el7") != -1 and int(upkver.split("-")[1].split(".")[0]) >= 693 and int(upkver.split("-")[1].split(".")[0]) < 862:
			fkver = OSKerMat["RHEL7.4"] #+ "." + proc
		elif upkver.find("el7") != -1 and int(upkver.split("-")[1].split(".")[0]) >= 862 and int(upkver.split("-")[1].split(".")[0]) < 957:
			fkver = OSKerMat["RHEL7.5"] #+ "." + proc
	        elif upkver.find("el7") != -1 and int(upkver.split("-")[1].split(".")[0]) >= 957 and int(upkver.split("-")[1].split(".")[0]) < 1062:
        	        fkver = OSKerMat["RHEL7.6"] #+ "." + proc
	        elif upkver.find("el7") != -1 and int(upkver.split("-")[1].split(".")[0]) >= 1062 and int(upkver.split("-")[1].split(".")[0]) < 1127:
        	        fkver = OSKerMat["RHEL7.7"] #+ "." + proc
	        elif upkver.find("el7") != -1 and int(upkver.split("-")[1].split(".")[0]) >= 1127 and int(upkver.split("-")[1].split(".")[0]) < 1160:
        	        fkver = OSKerMat["RHEL7.8"] #+ "." + proc
	        elif upkver.find("el7") != -1 and int(upkver.split("-")[1].split(".")[0]) >= 1160:
        	        fkver = OSKerMat["RHEL7.9"] #+ "." + proc
	        elif upkver.find("el8") != -1 and int(upkver.split("-")[1].split(".")[0]) >= 80 and int(upkver.split("-")[1].split(".")[0]) < 147:
        	        fkver = OSKerMat["RHEL8.0"] #+ "." + proc
	        elif upkver.find("el8") != -1 and int(upkver.split("-")[1].split(".")[0]) >= 147 and int(upkver.split("-")[1].split(".")[0]) < 193:
        	        fkver = OSKerMat["RHEL8.1"] #+ "." + proc
	        elif upkver.find("el8") != -1 and int(upkver.split("-")[1].split(".")[0]) >= 193 and int(upkver.split("-")[1].split(".")[0]) < 240:
        	        fkver = OSKerMat["RHEL8.2"] #+ "." + proc
	        elif upkver.find("el8") != -1 and int(upkver.split("-")[1].split(".")[0]) >= 240:
        	        fkver = OSKerMat["RHEL8.3"] #+ "." + proc
		elif upkver.split(".")[0]+"."+upkver.split(".")[1] == "3.0" and int(upkver.split("-")[0].split(".")[2]) > 13 :
			fkver = OSKerMat["SLES11X"]
		elif upkver.split(".")[0]+"."+upkver.split(".")[1] == "3.12" and int(upkver.split("-")[0].split(".")[2]) > 28 :
			fkver = OSKerMat["SLES12X"]
		elif upkver.split(".")[0]+"."+upkver.split(".")[1] == "4.4" and int(upkver.split("-")[0].split(".")[2]) >= 73 :
			fkver = OSKerMat["SLES12SP3"]
		elif upkver.split(".")[0]+"."+upkver.split(".")[1] == "4.12" and int(upkver.split("-")[0].split(".")[2]) >= 14 and sles12sp4_check == "buildsles12sp4":
			fkver = OSKerMat["SLES12SP4"]
		elif upkver.split(".")[0]+"."+upkver.split(".")[1] == "4.12" and int(upkver.split("-")[0].split(".")[2]) >= 14  :
			fkver = OSKerMat["SLES15"]
		elif upkver.split(".")[0]+"."+upkver.split(".")[1] == "4.4" and int(upkver.split("-")[0].split(".")[2]) >= 21 :
			fkver = OSKerMat["SLES12SP2"]
		elif upkver.split(".")[0]+"."+upkver.split(".")[1]+"."+upkver.split(".")[2].split("-")[0] == "3.19.0" and int(upkver.split("-")[1]) >= 25 :
			fkver = OSKerMat["ubuntu-14.04.3"]
		elif upkver.split(".")[0]+"."+upkver.split(".")[1]+"."+upkver.split(".")[2].split("-")[0] == "4.2.0" and int(upkver.split("-")[1]) >= 27 :
			fkver = OSKerMat["ubuntu-14.04.4"]
		elif upkver.split(".")[0]+"."+upkver.split(".")[1]+"."+upkver.split(".")[2].split("-")[0] == "4.4.0" and int(upkver.split("-")[1]) >= 21 :
			fkver = OSKerMat["ubuntu-16.04"]
		elif upkver.split(".")[0]+"."+upkver.split(".")[1]+"."+upkver.split(".")[2].split("-")[0] == "4.15.0" and int(upkver.split("-")[1]) >= 29 :
			fkver = OSKerMat["ubuntu-18.04"]
		elif upkver.split(".")[0]+"."+upkver.split(".")[1]+"."+upkver.split(".")[2].split("-")[0] == "5.4.0" and int(upkver.split("-")[1]) >= 26 :
			fkver = OSKerMat["ubuntu-20.04"]
		elif int(upkver.split(".")[0]) == 3 and int(upkver.split(".")[1]) in range(6, 19) :
			fkver = "3." + upkver.split(".")[1]
		elif int(upkver.split(".")[0]) == 4 and int(upkver.split(".")[1]) in range(1, 3) :
			fkver = "4.2"
		elif int(upkver.split(".")[0]) == 4 and int(upkver.split(".")[1]) in range(4, 6) :
			fkver = "4.5"
		elif int(upkver.split(".")[0]) == 4 and int(upkver.split(".")[1]) == 9 :
			fkver = OSKerMat["4.9"] + "." + upkver.split(".")[2].split("-")[0]
		elif int(upkver.split(".")[0]) == 4 and int(upkver.split(".")[1]) == 14 :
			fkver = "4.14"
		elif int(upkver.split(".")[0]) == 4 and int(upkver.split(".")[1]) == 19 :
			fkver = "4.19"
		elif int(upkver.split(".")[0]) == 5 and int(upkver.split(".")[1]) == 0 :
			fkver = "5.0"
		elif int(upkver.split(".")[0]) == 5 and int(upkver.split(".")[1]) == 2 :
			fkver = "5.2"
		elif int(upkver.split(".")[0]) == 5 and int(upkver.split(".")[1]) == 4 :
			fkver = "5.4"
		elif int(upkver.split(".")[0]) == 5 and int(upkver.split(".")[1]) == 6 :
			fkver = "5.6"
		elif int(upkver.split(".")[0]) == 5 and int(upkver.split(".")[1]) == 10 :
			fkver = "5.10"
	if fkver != "" :
		self.UNAME_R = fkver
		self.kernel_ver = fkver
		self.kvr = fkver
	else :
		code = None
		if inst == 0:
	...
	if ( "all" in self.components or "iwarp" in self.components ) and \
             ...
             sumHan.close()
        cmd = 'cat install.log | grep -A 28 -B 1 "Action"  >> Summary'
    ...
    def promptinstdeps(self, a ) :
        self.promptGaugeGen(a, texts="Checking dependencies")
        try :
            self.updateGaugeGen(a,20)
            misList = self.checkdeps()
	    time.sleep(1)
            self.updateGaugeGen(a,80)
	    time.sleep(1)
            self.updateGaugeGen(a,100)
            self.stopGaugeGen(a)
        except ValueError :
            pass

        if len(misList) > 0 :
            msg = "The following packages are not present in the machine, please install them and restart the installation.\n\n"
            msg += ", ".join(misList)
            msg += "\n\n" + 31*" " + "Press OK to Exit"
            a.msgbox(msg, width=80)
	    os.system("clear")
            sys.exit(2)

    def checkdeps(self, ) :
        misList = []
        depsList = ["make", "patch", "automake", "autoconf", "libtool", 
                    "python", "byacc", "flex", "lex", "bison"]
        if os.path.isfile("/usr/bin/dpkg") :
            depsList.append("dpkg-deb")
        else :
            depsList.extend(("rpm", "rpmbuild"))
...
class genCmdLine:
	...
	if self.c.configTune == 'Balanced Uwire':
	    ...
	    self.cmdline += ' CONF=UDP_OFFLOAD'
            ...
            self.cmdline += ' CONF=WIRE_DIRECT_LATENCY'
	elif self.c.configTune == 'High Capacity WD' :
            self.cmdline += ' CONF=HIGH_CAPACITY_WD '
	elif self.c.configTune == 'High Capacity VF' :
            self.cmdline += ' CONF=HIGH_CAPACITY_VF '
	elif self.c.configTune == 'High Capacity Hash Filter' :
	    self.cmdline += ' CONF=HIGH_CAPACITY_HASH_FILTER '
	elif self.c.configTune == "RDMA Performance" :
	    self.cmdline += ' CONF=RDMA_PERFORMANCE '
	elif self.c.configTune == "NVME Performance" :
	    self.cmdline += ' CONF=NVME_PERFORMANCE '
	...
	elif self.c.configTune == "Ring Backbone" :
	    self.cmdline += ' CONF=RING'
...
class make:
	...
	if setkpath:
		...
		or self.c.configTune == 'High Capacity WD' \
		or self.c.configTune == 'High Capacity VF' \
		or self.c.configTune == 'High Capacity Hash Filter' \
		or self.c.configTune == 'RDMA Performance' \
		or self.c.configTune == 'NVME Performance' \
		or self.c.configTune == 'iSCSI Performance' \
		or self.c.configTune == 'Memory Free' \
		or self.c.configTune == 'Ring Backbone' :
		self.cleanUninstall()
            #j+= 20
...
##                self.c.updateGaugeGen(self.a,j,progress="Installing")
    ...
    def checkBuild(self,kpaths):
        ...
        if kpaths == None :
            ...
            kpaths.append(os.path.join(
                "/","lib","modules",os.uname()[2],"build"))
        return os.path.isfile(os.path.join(kpaths[1],"Module.symvers"))
...
class setupConf:
    ...
    def fixConfig(self,components,configTune):
		...
		"High Capacity VF" : "build/src/network/firmware/high_capacity_vf/t4-config.txt",
		"High Capacity Hash Filter" : "build/src/network/firmware/high_capacity_hash_filter_config/t4-config.txt",
		"RDMA Performance" : "build/src/network/firmware/rdma_perf_config/t4-config.txt",
		"NVME Performance" : "build/src/network/firmware/nvme_perf_config/t4-config.txt",
        ...
        confgOpts = ["Balanced Uwire", "Low latency Networking", "High capacity TOE" ,"High capacity RDMA",  
                     "UDP Seg. Offload & Pacing", "T5 No External Memory", "High Capacity WD", "High Capacity VF", "High Capacity Hash Filter", "RDMA Performance",
		     "NVME Performance", "iSCSI Performance", "Memory Free" ]
	...
	if modconfTune == "High Capacity Hash Filter" or modconfTune == "high-capacity-hash-filter-config" :
	...
	if tx_coal == 1:
        ...
        msg += ' /sbin/t4_perftune.sh -n ' + options
	msg += ' > /dev/null ||. ; \n'
	handlers.write(msg)
        handlers.close()
...
class cmds:
    customtarget = [ 'all','vnic','nic', 'nic_offload', 'bonding','fcoe_full_offload_initiator','fcoe_pdu_offload_target','toe','iwarp', \
                     'iscsi_pdu_target', 'udp_offload', 'iscsi_pdu_initiator', 'toe_ipv4', 'nvme', 'lio', 'iser', 'crypto', 'sniffer', \
                     'ba_tools', 'wdtoe', 'wdtoe_wdudp', 'dpdk', 'ovs', 'tools', 'gpudirect', 'nvme_toe', 'nvme_toe_spdk' ]
    ofatargets = [ 'iwarp','sniffer']
    tuning = ['disable-affinity','enable-affinity','retain-irq-daemon','tx-coalasce']
    supportMatrix = {"3.0.13"     : ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "udp_offload",\
                                     "iscsi_pdu_target", "iscsi_pdu_initiator", "vnic", "iwarp", \
                                     "sniffer", "tools"],
                     "3.0.76"     : ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "udp_offload", \
                                     "iscsi_pdu_target", "iscsi_pdu_initiator", "vnic", "iwarp", \
                                     "sniffer", "tools"],
                     "3.0.101"     : ["bonding", "nic", "toe", "udp_offload", \
                                     "iscsi_pdu_target", "iscsi_pdu_initiator", "vnic", "tools"],
                     "3.12.28-4"  : ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "udp_offload", \
                                     "iscsi_pdu_target", "iscsi_pdu_initiator", "vnic", "iwarp", \
                                     "sniffer", "tools"],
                     "3.12.49-11"  : ["bonding", "nic", "toe","wdtoe", "wdtoe_wdudp", "udp_offload", \
                                     "iscsi_pdu_target", "iscsi_pdu_initiator", "vnic", "iwarp", \
                                     "sniffer", "tools"],
                     "4.4.21-69"   : ["bonding", "nic", "toe", "wdtoe_wdudp", "udp_offload", \
                                     "iscsi_pdu_target", "iscsi_pdu_initiator", "vnic", "iwarp", \
                                     "sniffer", "tools"],
                     "4.4.73-5"   : ["bonding", "nic", "toe","wdtoe", "wdtoe_wdudp", "udp_offload", \
                                     "iscsi_pdu_initiator", "vnic", "iwarp", "iser", "nvme", "lio", "crypto", \
                     ...
                     "4.12.14-195"   : ["bonding", "nic", "toe", "udp_offload",   \
                                     "iscsi_pdu_initiator", "vnic", "iwarp", "iser", "ovs", "nvme", "lio", "crypto", \
                                     "sniffer", "tools", "benchmarks"],
                     "2.6.32-71.el6"  : ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                      "sniffer", "tools"],
                     "2.6.32-131.0.15.el6"  : ["bonding", "nic", "toe","wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                      "sniffer", "tools"],
                     "2.6.32-220.el6"  : ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                      "sniffer", "tools"],
                     "2.6.32-279.el6"  : ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                      "sniffer", "tools"],
                     "2.6.32-358.el6"  : ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                      "sniffer", "tools"],
                     "2.6.32-431.el6"  : ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                      "sniffer", "tools"],
                     "2.6.32-504.el6"  : ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                      "sniffer", "tools"],
                     "2.6.32-573.el6"  : ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                      "sniffer", "tools"],
                     "2.6.32-642.el6"  : ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                      "sniffer", "tools"],
                     "2.6.32-696.el6"  : ["bonding", "nic", "toe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                      "sniffer", "tools"],
                     "2.6.32-754.el6"  : ["bonding", "nic", "toe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                      "sniffer", "tools"],
                     "3.0.101-63-default"  : ["bonding", "nic", "toe", "udp_offload", \
                                     "iscsi_pdu_target", "iscsi_pdu_initiator", "vnic", "tools"],
                     "3.10.0-123.el7.x86_64"  : ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                      "sniffer", "tools"],
                     "3.10.0-229.el7.x86_64"  : ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                      "sniffer", "tools"],
                     "3.10.0-229.el7.ppc64"  : ["bonding", "nic", "toe", "iwarp", "iscsi_pdu_target",  "iscsi_pdu_initiator", \
                                          "tools"],
                     "3.10.0-229.ael7b.ppc64le"  : ["bonding", "nic", "toe", "iwarp", "iscsi_pdu_target",  "iscsi_pdu_initiator", \
                                          "tools"],
                     "3.10.0-327.el7.x86_64"  : ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                      "sniffer", "dpdk",  "tools"],
                     "3.10.0-327.el7.ppc64le"  : ["bonding", "nic", "toe", "iwarp", "iscsi_pdu_target",  "iscsi_pdu_initiator", \
                                      "dpdk", "tools"],
                     "3.10.0-514.el7.x86_64"  : ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", \
                                       "iscsi_pdu_target", "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
                                      "sniffer", "crypto", "dpdk", "ovs", "tools"],
                     "3.10.0-514.el7.ppc64le"  : ["bonding", "nic", "toe", "iwarp", "iscsi_pdu_target",  "iscsi_pdu_initiator", \
                                          "dpdk", "tools"],
                     "3.10.0-693.el7.x86_64"  : ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", "udp_offload", "lio", \
                                       "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
                                      "sniffer", "crypto", "nvme", "dpdk", "iser", "ovs", "tools"],
                     "3.10.0-693.el7.ppc64le"  : ["bonding", "nic", "toe", "iwarp",  "iscsi_pdu_initiator", "lio", \
                                          "tools"],
                     "3.10.0-862.el7.x86_64"  : ["bonding", "nic", "toe", "vnic", "iwarp", "udp_offload", "lio", \
                                       "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
                                      "sniffer", "crypto", "nvme", "iser", "ovs", "tools"],
                     "3.10.0-862.el7.ppc64le"  : ["bonding", "nic", "toe", "iwarp",  "iscsi_pdu_initiator", "lio", \
                                          "tools"],
                     "3.10.0-957.el7.x86_64"  : ["bonding", "nic", "toe", "vnic", "iwarp", "udp_offload", "lio", \
                                       "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
                                      "sniffer", "crypto", "nvme", "iser", "ovs", "tools"],
                     "3.10.0-957.el7.ppc64le"  : ["bonding", "nic", "toe", "iwarp",  "iscsi_pdu_initiator", "lio", \
                                          "tools"],
                     "3.10.0-1062.el7.x86_64"   : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", "lio", \
                                       "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
                                      "sniffer", "crypto", "nvme", "iser", "ovs", "tools","benchmarks"],
                     "3.10.0-1127.el7.x86_64"   : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                       "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
                                      "sniffer", "crypto", "nvme", "iser", "ovs", "tools", "nvme_toe_spdk", "lio"],
                     "3.10.0-1160.el7.x86_64"   : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                       "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
                                      "sniffer", "crypto", "nvme", "iser", "ovs", "tools", "nvme_toe_spdk", "lio"],
                     "4.18.0-80.el8.x86_64"   : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", "lio", \
                     ...
                     "4.18.0-193.el8.x86_64"   : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                       "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
                                       "sniffer", "crypto", "nvme", "iser", "tools", "nvme_toe_spdk", "lio"],
                     "4.18.0-240.el8.x86_64"   : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                       "iscsi_pdu_initiator", "fcoe_full_offload_initiator", \
                                       "sniffer", "crypto", "nvme", "iser", "tools", "nvme_toe", "nvme_toe_spdk", "lio"],
                     "3.19.0-25"     : ["bonding", "nic", "toe", "wdtoe_wdudp", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_target",  "iscsi_pdu_initiator", \
                                        "sniffer", "tools"],
                     "4.2.0-27"     : ["bonding", "nic", "toe", "wdtoe_wdudp", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_target",  "iscsi_pdu_initiator", \
                                        "sniffer", "tools"],
		     "4.4.0-21-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_target",  "iscsi_pdu_initiator", \
                                        "sniffer", "crypto", "tools", "benchmarks"],
                     "4.4.0-31-generic"     : ["bonding", "nic", "toe", "wdtoe_wdudp", "iwarp",  "vnic", "udp_offload", \
                                         "iscsi_pdu_target", "iscsi_pdu_initiator",  \
                                        "crypto", "sniffer", "tools"],
                     "4.4.0-116-generic"     : ["bonding", "nic", "toe", "wdtoe_wdudp", "iwarp",  "vnic", "udp_offload", \
                                         "iscsi_pdu_target", "iscsi_pdu_initiator",  \
                                        "crypto", "sniffer", "tools"],
                     "4.4.0-131-generic"     : ["bonding", "nic", "toe", "iwarp",  "vnic", "udp_offload", \
                                         "iscsi_pdu_target", "iscsi_pdu_initiator",  \
                                        "crypto", "sniffer", "tools"],
                     "4.4.0-142-generic"     : ["bonding", "nic", "nic_offload", "toe",  "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_target", "iscsi_pdu_initiator",  \
                     ...
                     "4.15.0-45-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", \
                                        "iscsi_pdu_initiator",  \
                                        "sniffer", "crypto", "lio", "nvme", "iser",  "tools", "benchmarks"],
                     "4.15.0-55-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools", "benchmarks"],
                     "5.4.0-26-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator",  \
                     ...
                     "5.4.0-65-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools", "nvme_toe", "nvme_toe_spdk"],
                     "5.4.0-66-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools", "nvme_toe", "nvme_toe_spdk"],
                     "5.4.0-67-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools", "nvme_toe", "nvme_toe_spdk"],
                     "5.4.0-68-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools", "nvme_toe", "nvme_toe_spdk"],
                     "5.4.0-69-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools", "nvme_toe", "nvme_toe_spdk"],
                     "5.4.0-70-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools", "nvme_toe", "nvme_toe_spdk", "lio"],
                     "5.4.0-71-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools", "nvme_toe", "nvme_toe_spdk", "lio"],
                     "5.4.0-72-generic"     : ["bonding", "nic", "nic_offload", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools", "nvme_toe", "nvme_toe_spdk", "lio"],
                     "4.15.0-126-generic"     : ["bonding", "nic", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools"],
                     "4.15.0-135-generic"     : ["bonding", "nic", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools"],
                     "4.15.0-136-generic"     : ["bonding", "nic", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools"],
                     "4.15.0-137-generic"     : ["bonding", "nic", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools"],
                     "4.15.0-138-generic"     : ["bonding", "nic", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools"],
                     "4.15.0-139-generic"     : ["bonding", "nic", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools"],
                     "4.15.0-140-generic"     : ["bonding", "nic", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools"],
                     "4.15.0-141-generic"     : ["bonding", "nic", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools"],
                     "4.15.0-142-generic"     : ["bonding", "nic", "toe", "iwarp", "vnic", "udp_offload", \
                                        "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "lio",  \
                                        "sniffer", "crypto",  "nvme", "iser", "tools"],
                     "3.4"      : ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", \
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                   "sniffer", "tools", "udp_offload"],
                     "3.6"	: ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", \
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                   "sniffer", "fcoe_pdu_offload_target", "tools", "udp_offload"],
                     "3.7"	: ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp",  \
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", "sniffer", \
                                   "tools", "udp_offload"],
                     "3.8"      : ["bonding", "nic", "toe", "vnic", "iwarp", "iscsi_pdu_target", "iscsi_pdu_initiator",  "tools", \
                                   "udp_offload"],
                     "3.9"      : ["nic", "toe", "iwarp", "iscsi_pdu_target", "iscsi_pdu_initiator",  "tools"],
                     "3.10"      : ["nic", "toe", "iwarp", "iscsi_pdu_target", "iscsi_pdu_initiator",  "tools"],
                     "3.11"      : ["nic", "toe", "iwarp", "iscsi_pdu_target", "iscsi_pdu_initiator",  "tools"],
                     "3.12"      : ["nic", "toe", "iwarp", "iscsi_pdu_target", "iscsi_pdu_initiator",  "tools"],
                     "3.13"      : ["nic", "toe", "iwarp", "iscsi_pdu_target", "iscsi_pdu_initiator",   \
                                    "tools"],
                     "3.14"      : ["bonding", "nic", "toe", "iwarp", "iscsi_pdu_target", "iscsi_pdu_initiator",  "lio", \
                                    "tools"],
                     "3.16"	: ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp", "vnic", "iwarp", \
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                   "sniffer", "tools", "udp_offload"],
                     "3.17"	: ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp","vnic", "iwarp", \
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                   "sniffer", "tools", "udp_offload"],
                     "3.18"	: ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp","vnic", "iwarp", \
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                   "sniffer", "tools", "udp_offload"],
                     "4.1"	: ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp","vnic", "iwarp", \
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                   "sniffer", "tools", "udp_offload"],
                     "4.4"	: ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp","vnic", "iwarp",  \
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                   "sniffer", "tools", "udp_offload"],
                     "4.5"	: ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp","vnic", "iwarp",  \
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                   "crypto", "sniffer", "tools", "udp_offload"],
                     "4.8"	: ["bonding", "nic", "toe", "wdtoe", "wdtoe_wdudp","vnic", "iwarp",\
                                   "iscsi_pdu_target", "iscsi_pdu_initiator", \
                                   "sniffer", "nvme", "lio", "iser", "crypto", "tools", "udp_offload"],
                     "4.9"	: ["bonding", "nic", "toe", "wdtoe_wdudp","vnic", "iwarp",\
                                   "iscsi_pdu_initiator", \
                                   "sniffer", "nvme", "lio", "iser", "crypto", "ovs", "tools", "udp_offload"],
                     "4.14"	: ["bonding", "nic", "toe", "udp_offload", "vnic", "iwarp", "iscsi_pdu_initiator", "sniffer", "nvme", "lio", "iser", "crypto", "tools"],
                     "4.19"	: ["bonding", "nic", "toe", "udp_offload", "vnic", "iwarp", "iscsi_pdu_initiator", "sniffer", "nvme", "lio", "iser", "crypto", "tools"],
                     "5.4"	: ["bonding", "nic", "nic_offload", "toe", "udp_offload", "vnic", "iwarp", "iscsi_pdu_initiator", "fcoe_full_offload_initiator", "sniffer", "nvme", "iser", "crypto", "tools", "benchmarks", "nvme_toe", "nvme_toe_spdk", "lio"],
                     "5.0"	: ["nic", "nic_offload", "toe", "tools", "benchmarks"],
                     "5.2"	: ["nic", "nic_offload", "toe", "tools", "benchmarks"],
                     "5.6"	: ["bonding", "nic", "nic_offload", "toe", "tools", "benchmarks"],
    ...
    ofedsupportMatrix1 = dict.fromkeys(["2.6.32-431", "2.6.32-504", "2.6.32-573", "2.6.32-642", \
                                            "3.10.0-123", "3.10.0-229", "3.10.0-327", \
                                            "3.0.76", "3.12.28-4", "3.12.49-11", "3.18"],['3.18-3'])
    ofedsupportMatrix1.update(dict.fromkeys(["3.10.0-123", "3.10.0-210", "3.10.0-327", "3.10.0-514", "3.12.28-4", "3.12.49-11", "4.4.21-69"], ['4.8-1']))
    ofedsupportMatrix1.update(dict.fromkeys(["3.10.0-123", "3.10.0-210", "3.10.0-327", "3.10.0-514", "3.10.0-693", "3.12.28-4", "3.12.49-11", "4.4.21-69", "4.4.73-5"], ['4.8-2']))
	...
	nodeThreadArr= []
	ix = 0
        rawPkgName="ChelsioUwire-3.14.0.3"
        pkgName="ChelsioUwire-3.14.0.3.tar.gz"
	...
	clusGroup = OptionGroup(parser, "Cluster Deployment Options")
        inGroup.add_option("-c", "--custom", dest="target",
                          ...
                          "Targets can be one or many(':' separated) of nic, vnic, toe, toe_ipv4, bonding, iwarp, "+
                          "iscsi_pdu_target, iscsi_pdu_initiator, tools, "+
                          "fcoe_full_offload_initiator, nvme, nvme_toe, nvme_toe_spdk, lio, iser, crypto, ovs, sniffer, udp_offload, all. ")
	...
	cmnGroup.add_option("--set-kpath",dest="setkpath", action="store_true", default="False",help="Prompt for Kernel path in GUI" )
    ...
    def genCmdline(self) :
        temp1 = []
	if self.genRpmpack :
	    self.cmdline = "make iwarp_rpm toe_rpm tools_rpm rpmgen=1 "
	...
	if self.ksrc != None:
        ...
        if self.kobj != None:
            self.cmdline = self.cmdline + ' KOBJ=' + self.kobj
	    ...
	    self.cmdline += ' CONF=UDP_OFFLOAD'
            ...
            self.cmdline += ' CONF=HIGH_CAPACITY_VF'
	elif self.configTune == "high-capacity-hash-filter-config" :
	    self.cmdline += ' CONF=HIGH_CAPACITY_HASH_FILTER '
	elif self.configTune == "rdma-perf-config" :
	    self.cmdline += ' CONF=RDMA_PERFORMANCE '
	elif self.configTune == "nvme-perf-config" :
	    self.cmdline += ' CONF=NVME_PERFORMANCE '
	elif self.configTune == "iscsi-perf-config" :
            self.cmdline += ' CONF=ISCSI_PERFORMANCE '
	elif self.configTune == "memfree-config" :
            self.cmdline += ' CONF=MEMORY_FREE '
	elif self.configTune == "ring-config" :
            self.cmdline += ' CONF=RING '
    ...
    def fixConfig(self):
        ...
        config_files_cli = {"unified-wire-fcoe-init"   : "build/src/network/firmware/t4-config.txt",
                            ...
                            "high-capacity-wd"         : "build/src/network/firmware/high_capacity_wd/t4-config.txt",
                            "high-capacity-vf"         : "build/src/network/firmware/high_capacity_vf/t4-config.txt",
                            "high-capacity-hash-filter-config"       : "build/src/network/firmware/high_capacity_hash_filter_config/t4-config.txt",
			    "rdma-perf-config"	       : "build/src/network/firmware/rdma_perf_config/t4-config.txt",
			    "nvme-perf-config"	       : "build/src/network/firmware/nvme_perf_config/t4-config.txt",
			    ...
			    "ring-config"	       : "build/src/network/firmware/ring_config/t4-config.txt"
                            }
    ...
    def checkConfigTune(self):
        confgOpts = ["unified-wire-fcoe-init", "low-latency-networking", "high-capacity-toe", "high-capacity-rdma", \
                     "udp-offload-config", "edc-only-config", "high-capacity-wd", "high-capacity-vf", "high-capacity-hash-filter-config", "rdma-perf-config", "nvme-perf-config", "iscsi-perf-config", "memfree-config" , "ring-config"]
        found=0
        if self.configTune != None:
	...
	#print "kversion",kversion
        ...
        if self.clusDeploy :
            data += \
                '''Press %d, Unified Wire, Configures to run all protocols simultaneously(Default)'''%(ix)
        else :
            data += \
                '''Press %d, Unified Wire, Configures to run all protocols simultaneously(Default)'''%(ix)
	if kversion.find("4.15.0") != -1 or kversion.find("5.0") == -1:
	...
	if self.clusDeploy or "iwarp" in customTarget:
            data += \
                '''Press %d, Low Latency Networks, Configures Low Latency TOE;iWARP'''%(ix)
            menu[ix] = 'low-latency-networking'
            ix += 1
            if data != '':
                data = data + '\n'
            data += \
                '''Press %d, High Capacity RDMA, Configures large number of iWARP connections'''%(ix)
            menu[ix] = 'high-capacity-rdma'
            ix += 1
            if data != '':
                data = data + '\n'
            data += \
                '''Press %d, RDMA Performance, iWARP performance optimized configuration'''%(ix)
            menu[ix] = 'rdma-perf-config'
            ix += 1
            if data != '':
                data = data + '\n'
	    if kversion.find("2.6.32-754.el6") == -1 and kversion.find("2.6.32-696.el6") == -1 and kversion.find("4.4.21-69") == -1 and kversion.find("3.0.101") == -1 and kversion.find("4.4.0-21-generic") == -1 :
		if platform.processor().find("ppc64") == -1:
			data += \
		            	    '''Press %d, NVME Performance, NVMe performance optimized configuration'''%(ix)
			menu[ix] = 'nvme-perf-config'
			ix += 1
			if data != '':
				data = data + '\n'
        else :
            data += \
                '''Press %d, Low Latency Networks, Configures Low Latency TOE'''%(ix)
            menu[ix] = 'low-latency-networking'
            ix += 1
            if data != '':
                data = data + '\n'
	if not self.clusDeploy and "toe" in customTarget:
	    if kversion.find("4.15.0") != -1 or kversion.find("5.0") == -1:
            	data += \
                	'''Press %d, High Capacity TOE, Configures large number of TOE connections'''%(ix)
            	menu[ix] = 'high-capacity-toe'
            	ix += 1
            	if data != '':
                	data = data + '\n'
	if not self.clusDeploy and ( "iscsi_pdu_target" in customTarget or "iscsi_pdu_initiator" in customTarget) :
            data += \
                '''Press %d, iSCSI Performance, iSCSI performance optimized configuration'''%(ix)
            menu[ix] = 'iscsi-perf-config'
            ix += 1
            if data != '':
                data = data + '\n'
	if not self.clusDeploy and "udp_offload" in customTarget:
	    if arch.find("aarch64") == -1 :
	        data += \
	            '''Press %d, UDP Segmentation Offload & Pacing, Configures large number of UDP offload connections'''%(ix)
	...
	if not self.clusDeploy and "iwarp" in customTarget:
	    if arch.find("aarch64") == -1 :
	        data += \
	            '''Press %d, Wire Direct Latency, Configures Low Latency WireDirect'''%(ix)
	    ...
	    if platform.processor().find('ppc64') == -1 and platform.processor().find('aarch64') == -1 :
                if data != '':
                    data = data + '\n'
                data += \
                    '''Press %d, High Capacity WD, Configures large number of WD connections'''%(ix)
	...
	if not self.clusDeploy :
	   if kversion.find("4.15.0") != -1 or kversion.find("5.0") == -1:
		if kversion.find("5.6") == -1 and platform.processor().find('ppc64') == -1 and platform.processor().find('aarch64') == -1 :
			data += \
				'''Press %d, High Capacity VF, Configures large number of VF connections'''%(ix)
			menu[ix] = 'high-capacity-vf'
			ix += 1
		...
		if kversion.find("5.6") == -1 :
			data += \
				'''Press %d, High Capacity Hash Filter, Configures large number of filters'''%(ix)
			menu[ix] = 'high-capacity-hash-filter-config'
			ix += 1
			if data != '':
				data = data + '\n'
	"""if self.clusDeploy or "iwarp" in customTarget:
            data += \
                '''Press %d, Memory Free, Configures TOE;iWARP offload in Memory-free mode'''%(ix)
	...
	"""if kversion.find("4.15.0") != -1 or kversion.find("5.0") == -1:
		data += \
		'''Press %d, Ring Backbone, For Ring Backbone Configuration'''%(ix)
		menu[ix] = 'ring-config'
		ix += 1
	...
	if len(data) > 1:
            ...
            labels = ('Choice',' Terminator Configuration',' Supported Protocols/Drivers')
	...
	if self.configTune == "low-latency-networking" or self.configTune == "edc-only-config"  \
           or self.configTune == "high-capacity-wd": 
	    toremove = [ "vnic", "toe","toe_ipv4", "libs", "bypass", "nic", "wdtoe_wdudp", "fcoe_pdu_offload_target"]
	    if self.configTune != "low-latency-networking" :
	       toremove.append("bonding")
            '''if kversion.find('2.6.35') != -1 or kversion.find("3.2.0-23") != -1 or  kversion.find("3.5.0-23") != -1 :
                toremove.remove("toe")'''
	else :
	    toremove = [ "toe_ipv4", "libs", "bypass", "nic", "wdtoe", "wdtoe_wdudp", "fcoe_pdu_offload_target",  "crypto", "ovs", "dpdk"]
            if self.configTune == "high-capacity-vf" :
                toremove = [ "toe_ipv4", "libs", "bypass", "nic_offload", "wdtoe", "wdtoe_wdudp", "fcoe_pdu_offload_target",  "crypto", "ovs", "dpdk"]
	    if self.configTune == "high-capacity-hash-filter-config" :
	        toremove.append("ovs")
	if self.configTune == "unified-wire-fcoe-init" or self.configTune == "ring-config" :
	    toremove.append("udp_offload")
	    if self.configTune =="ring-config" :
	        toremove.append("fcoe_full_offload_initiator")
	...
	if self.clust_install_opt == 'homgen-cluster' :
		...
		cmd = "cp -rf RPM-Manager ChelsioUwire-3.14.0.3-RPM-Installer"
		sts, out = commands.getstatusoutput(cmd)
		if sts != 0 :
		    print "RPM copy failed for Cluster Installation"
		    sys.exit(1)
		
		cmd = "tar czf ChelsioUwire-3.14.0.3-RPM-Installer.tar.gz ChelsioUwire-3.14.0.3-RPM-Installer"
		sts, out = commands.getstatusoutput(cmd)
		if sts != 0 :
	...
	def runcopyCmd(cmd):
            ...
            return cmd,k.returncode,k.pid
	self.installOfed = True
        cmd = 'cp -rf OFED/%s/RPMS/*/'+ os.uname()[4] + '/* RPM-Manager/OFED-RPMS/. '%(self.ofedcpkgName)
	print "Copying Ofed RPMS"
	cmd,retc,pi = runcopyCmd(cmd)
	if retc !=0 :
	    print "Ofed RPMS Copy Failed"
	    return False
        cmd = "cp -rf rpmbuild/RPMS/"+ os.uname()[4] +"/* RPM-Manager/DRIVER-RPMS/ofed/."
	cmd,retc,pi = runcopyCmd(cmd)
	if retc !=0 :
	...
	if os.uname()[2] == '2.6.32-754.el6.x86_64'  :
		return

	if os.uname()[2] == '2.6.32-696.el6.x86_64'  :
		return
        ix = 1
        data += \
	...
	customTarget = []
	    ...
	    if "ovs" in self.target:
		self.target.remove("ovs")

        elif self.configTune == "low-latency-networking" or \
            self.configTune == "high-capacity-rdma" :
	    toRemove = []
	    if self.configTune in ["high-capacity-rdma"] :
		confSupport = ["nic", "nic_offload", "iwarp", "libs", "tools"]
	    else:
		confSupport = ["nic", "nic_offload", "toe", "toe_ipv4","wdtoe", "wdtoe_wdudp","iwarp","bonding", "sniffer","libs","tools"]
	    if "all" in self.target:
                self.target = customTarget
		self.removeUnsupported()
            else:
	    ...
	    for i in toRemove:
		del(self.target[i])
	elif self.configTune == "rdma-perf-config" or self.configTune == "nvme-perf-config" or \
	     self.configTune == "memfree-config":
            toRemove = []
	    if self.configTune == "rdma-perf-config" or self.configTune == "nvme-perf-config" :
               confSupport = ["nic", "nic_offload", "iwarp", "nvme", "nvme_toe_spdk", "iser", "libs", "tools"]
	    else :
            ...
            toRemove = []
            confSupport = ["nic", "nic_offload", "toe", "wdtoe","wdtoe_wdudp","iwarp", "libs","tools"]
            if "all" in self.target:
                self.target = customTarget
                self.removeUnsupported()
            else:
	    ...
	    toRemove = []
	    if kversion.find("4.18.0-240.el8") != -1 or kversion.find("4.18.0-193.el8") != -1 or kversion.find("4.18.0-147.el8") != -1 or kversion.find("4.18.0-80.el8") != -1 or kversion.find("3.10.0-1127.el7") != -1 or kversion.find("3.10.0-1160.el7") != -1 or kversion.find("3.10.0-1062.el7") != -1 or kversion.find("3.10.0-957.el7") != -1 or kversion.find("3.10.0-862.el7") != -1 or platform.processor().find("ppc64") != -1 or kversion.find("4.9") != -1 or kversion.find("4.14") != -1 or kversion.find("4.19") != -1 or kversion.find("5.4") != -1 or kversion.find("5.6") != -1 or kversion.find("5.10") != -1 or  kversion.find("4.4.73-5") != -1 or  kversion.find("4.12.14-94.41") != -1 or  kversion.find("4.12.14-23") != -1 or  kversion.find("4.12.14-195") != -1 or  kversion.find("4.15.0-29-generic") != -1 or  kversion.find("4.15.0-55-generic") != -1  or  kversion.find("4.15.0-76-generic") != -1 or kversion.find("4.15.0-126-generic") != -1 or kversion.find("5.4.0-26-generic") != -1 or kversion.find("5.4.0-54-generic") != -1 or kversion.find("5.4.0-65-generic") != -1 :
	        confSupport = ["nic", "iscsi_pdu_initiator", "lio", "tools"]
	    else :
            	confSupport = ["nic", "nic_offload","toe","bonding","iscsi_pdu_target","iscsi_pdu_initiator", "lio", "tools"]
	    print "confSupport=",confSupport
            if "all" in self.target:
                self.target = customTarget
                self.removeUnsupported()
            else:
            ...
            for i in toRemove:
                del(self.target[i])
	elif self.configTune == "high-capacity-hash-filter-config" or self.configTune == "high-capacity-vf":
            toRemove = []
            if self.configTune == "high-capacity-vf" :
                confSupport = ["nic", "vnic", "tools"]
                self.customtarget.insert(1,"nic")
            else :
                confSupport = ["nic_offload", "ovs", "tools"]
	...
	if comp not in customTarget:
		...
		conftoprint = "WIRE_DIRECT_LATENCY"
	    else:
	...
	OSKerMat = { "RHEL6.X"          : "2.6.32-642.el6",
		     "RHEL6.9"          : "2.6.32-696.el6",
		     "RHEL6.10"         : "2.6.32-754.el6",
		     "RHEL7.X"          : "3.10.0-327.el7",
		     "RHEL7.3"          : "3.10.0-514.el7",
		     "RHEL7.4"          : "3.10.0-693.el7",
		     "RHEL7.5"          : "3.10.0-862.el7",
	...
	for i in range(len(supportMatrix)):
		...
		sles12sp4_check = os.uname()[1]
		if upkver.find("el6") != -1 and int(upkver.split("-")[1].split(".")[0]) > 279 and int(upkver.split("-")[1].split(".")[0]) < 696:
			fkver = OSKerMat["RHEL6.X"] #+ "." + proc
		elif upkver.find("el6") != -1 and int(upkver.split("-")[1].split(".")[0]) >= 696 and int(upkver.split("-")[1].split(".")[0]) < 754:
			fkver = OSKerMat["RHEL6.9"] #+ "." + proc
		elif upkver.find("el6") != -1 and int(upkver.split("-")[1].split(".")[0]) >=754:
			fkver = OSKerMat["RHEL6.10"] #+ "." + proc
		elif upkver.find("el7") != -1 and int(upkver.split("-")[1].split(".")[0]) > 123 and int(upkver.split("-")[1].split(".")[0]) < 514 :
			fkver = OSKerMat["RHEL7.X"] + "." + proc
		elif upkver.find("el7") != -1 and int(upkver.split("-")[1].split(".")[0]) >= 514 and int(upkver.split("-")[1].split(".")[0]) < 693 :
			fkver = OSKerMat["RHEL7.3"] #+ "." + proc
...
def cmdMain():
	...
	pt = prompt()
        prints = sys.stdout.write
	'''misList = pt.checkdeps()
	if len(misList) > 0 :
	    os.system('clear')
	    printChelsioHeader()
	    msg = "\nThe following packages are not present in your machine, please install them and restart the installation\n"
            msg += "\033[91m" + ", ".join(misList) + "\033[0m" +"\n\n"
	    prints(msg)
	    sys.exit(2)'''
        c.parseArgs(sys.argv[1:])
	c.checkKernelVers()
	...
	if ( c.uninstall != True ) :
	    ...
	    for ver in c.ofedsupportMatrix1.keys() :
                if kversion.find(ver) != -1 :
                    c.ofedkver = ver
                    break
	    if c.ofedkver != None and not ( c.configTune in ["iscsi-perf-config", "high-capacity-hash-filter-config", "high-capacity-toe", "udp-offload-config"] ) :
	            if "all" in c.target or "iwarp" in c.target or "wdtoe_wdudp" in c.target or "sniffer" in c.target :
...
def cmdDialog():
    ...
    while True :
	    ...
	    handler = open("install.log","w")
            a = dialog.Dialog()
            a.add_persistent_args(["--colors","--backtitle", "\Zb\Z7Chelsio Unified Installer v2.0            press ESC or Ctl+C to exit\Zn"],)
            c = prompt()
		...
		c.components[ix] = c.components[ix].strip('"')
            ...
            if c.uninstall :
                ...
                s = make(a,c)
                a.add_persistent_args(["--backtitle", "Chelsio Unified Installer v2.0"])
...
def clusterhmgDeployerThread(cmdObj,node):
	...
	confTune = 'UNIFIED_WIRE'
        ...
        confTune = 'WIRE_DIRECT_LATENCY'
    elif cmdObj.configTune == "high-capacity-wd":
        confTune = 'HIGH_CAPACITY_WD'
    elif cmdObj.configTune == "high-capacity-vf":
        confTune = 'HIGH_CAPACITY_VF'
    elif cmdObj.configTune == "high-capacity-hash-filter-config" :
        confTune = 'HIGH_CAPACITY_HASH_FILTER'
    elif cmdObj.configTune == "rdma-perf-config" :
        confTune = 'RDMA_PERFORMANCE'
    elif cmdObj.configTune == "nvme-perf-config" :
        confTune = 'NVME_PERFORMANCE'
    ...
    elif cmdObj.configTune == "ring-config" :
        confTune = 'RING'

    rawPkgName="ChelsioUwire-3.14.0.3-RPM-Installer"
    pkgName="ChelsioUwire-3.14.0.3-RPM-Installer.tar.gz"
    pkgDir= os.path.abspath('.')
    absPkgPath= pkgDir + os.sep + rawPkgName
...
def checkDialogdeps():
    ff = "-y"
    nc_lib = "ncurses-devel"
    cmd = "which gcc"
    status, output = commands.getstatusoutput(cmd)
    if status != 0 :
        nc_lib += " gcc"
    for upr in ["yum", "zypper", "apt-get"]:
        cmd = 'which ' + upr ;
        status, output = commands.getstatusoutput(cmd)
        if status == 0 :
            if upr == "zypper" :
               ff = "-n"
            if upr == "apt-get" :
               nc_lib = "libncurses-dev"
            cmd = upr + " " + ff + " install gcc " + nc_lib
            status, output = commands.getstatusoutput(cmd)
    	    if status != 0 :
                print "\nPlease configure %s to install dependencies for dialog"%upr
                print "OR install the below packages manually and restart the installation."
                print "gcc, %s \n"%nc_lib
                sys.exit(1)
            else :
                break
    else :
        print "\nUnable to install dependencies for dialog using yum/zypper/apt-get,"
        print "Please install the below packages manually and restart the installation."
        print "gcc, %s \n"%nc_lib
        sys.exit(1)
    ...
    if status != 0 :
        ...
        for upr in ["yum", "zypper", "apt-get"]:
            ...
            if status == 0 :
                if upr == "zypper" :
                   ff = "-n"
                cmd = upr + " " + ff + " install " + nc_lib
                status, output = commands.getstatusoutput(cmd)
                print cmd
                print output
                if status != 0 :
                    print "\n\"make\" installation Failed using %s"%upr
                    print "Please install \"make\" and restart the installation."
                    sys.exit(1)
                else :
                    break
        else :
            print "\nUnable to install \"make\" using yum/zypper/apt-get,"
            print "Please install make and restart the installation.\n"
            sys.exit(1)
...
def installDialog():
    ...
    status, output = commands.getstatusoutput(cmd)
    if int(status) > 0 :
        print "Installing dependencies for dialog on machine."
        checkDialogdeps()
        os.chdir(pwd)
        os.system('clear')
...
def main():
    ...
    global setkpath
    setkpath = cmdObj.setkpath
    try:
        instMake()
	if cmdObj.silent:
	    cmdSilent()
        elif len(sys.argv) > 1 and not setkpath:
            cmdMain()
