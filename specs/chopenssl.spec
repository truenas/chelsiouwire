...
make -C engines/af_alg/ CHFDIR=$RPM_BUILD_ROOT/%{openssldir}
install -D -v -m 755 engines/af_alg/libaf_alg.so $RPM_BUILD_ROOT/%{openssldir}/lib/engines/
...
#%attr(0755,root,root) /chssl/lib/*.so*
%attr(0755,root,root) %{openssldir}/misc/*
%attr(0755,root,root) %{openssldir}/lib/engines/*
