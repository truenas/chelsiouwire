...
#ifdef __ISCSI_SCST__
bool chiscsi_context_thread = true;
module_param(chiscsi_context_thread, bool, 0444);
MODULE_PARM_DESC(chiscsi_context_thread, "Use scst thread context for cmd processing (default = true)");
#endif
