...
int t4vf_enable_pi(struct adapter *, struct port_info *, bool, bool);
...
int t4vf_free_mac_filt(struct adapter *, unsigned int, unsigned int naddr,
		       const u8 **, bool);
int t4vf_change_mac(struct adapter *, unsigned int, int, const u8 *, bool, u8*);
...
int t4vf_get_port_stats_fw(struct adapter *, int, struct t4vf_port_stats *);

int t4vf_iq_free(struct adapter *, unsigned int, unsigned int, unsigned int,
		 unsigned int);
int t4vf_eth_eq_free(struct adapter *, unsigned int);

const char *t4vf_link_down_rc_str(unsigned char);
void t4vf_handle_get_port_info(struct port_info *,
