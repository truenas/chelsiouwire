...
#include <csio_rnode_isns.h>
#define CSIO_RNF_CLOSING_CONN   0x1
#define CSIO_RNF_ADJ_PARAM      0x2
#endif
...
#ifdef __CSIO_COISCSI_ENABLED__
	struct coiscsi_snode	*snp;		/* Pointer to owning Snode */
#endif
...
#ifdef __CSIO_COISCSI_ENABLED__
#define csio_rnode_to_coiscsi(rn)	(&(rn)->un.rnc)
#define csio_rnode_to_isns(rn)	(&(rn)->un.rns)
#define csio_rnode_to_snode(rn)	((rn)->snp)
#endif
