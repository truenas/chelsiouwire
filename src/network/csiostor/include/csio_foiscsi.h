...
/* Default rcv_win = 256k, wsf = log2(rcv_win/64k) */
#define ISCSI_DEFAULT_WSF 2

static inline void hex_dump(u8 *data, int len)
{
	int i;
...
void csio_foiscsi_clear_logout_all(struct csio_hw *, int);
