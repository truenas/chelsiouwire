...
enum {
	...
	CSIO_FOISCSI_RSESS_MD,
#ifdef __CSIO_COISCSI_ENABLED__
	CSIO_COISCSI_LN_MD,
	CSIO_COISCSI_TGT_PORTAL_MD,
	CSIO_COISCSI_RN_MD,
	CSIO_COISCSI_SN_MD,
	CSIO_COISCSI_FLB_SCSI_MD,
	CSIO_COISCSI_TGTREQ_MD,
	CSIO_COISCSI_RCVREQ_MD,
	CSIO_COISCSI_DBUF_MD,
	CSIO_ISNS_LN_MD,
	CSIO_ISNS_RN_MD,
	CSIO_ISNS_SN_MD,
#endif
...
struct csio_hw_os_ops {
	...
	int (*os_rn_reg_rnode)(struct csio_rnode *);
	...
	struct csio_lnode *(*os_alloc_coiscsi_lnode)(struct csio_hw *);
	struct csio_rnode *(*os_alloc_coiscsi_rnode)(struct coiscsi_snode *);
	void (*os_free_coiscsi_rnode)(struct csio_rnode *);
	struct csio_rnode *(*os_alloc_isns_rnode)(struct csio_hw *, struct csio_list *);
	void (*os_free_isns_rnode)(struct csio_hw *, struct csio_rnode *);
#endif
};
...
struct csio_hw {
...
#ifdef __CSIO_COISCSI_ENABLED__
	/* Added for COiSCSI */
	struct csio_coiscsi_tgtm	coiscsi_tgtm;

	/* Added for iSNS */
	struct csio_isnsm		isnsm;
#endif
	/* Children */
...
#ifdef __CSIO_PORT_EVTQ__
	int			portevt_iq_idx[CSIO_MAX_T4PORTS];
#endif
	...
	uint32_t		transport_init_done;	/* Flag to mark iscsi
	...
	uint32_t		fwevt_intr_idx;		/* FW evt MSIX/interrupt
							 ...
							 */
#ifdef __CSIO_PORT_EVTQ__
	uint32_t		portevt_intr_idx[CSIO_MAX_T4PORTS];
#endif
...
#ifdef __CSIO_COISCSI_ENABLED__
static inline struct csio_coiscsi_tgtm *
csio_hw_to_coiscsi_tgtm(struct csio_hw *hw)
{
	return &hw->coiscsi_tgtm;
}

static inline struct csio_isnsm *
csio_hw_to_isnsm(struct csio_hw *hw)
{
	return &hw->isnsm;
}
#endif
...
#ifdef __CSIO_PORT_EVTQ__
#define csio_set_portevt_intr_idx(_h, _pi, _i)	((_h)->portevt_intr_idx[_pi] = (_i))
#define csio_get_portevt_intr_idx(_h, _pi)	((_h)->portevt_intr_idx[_pi])
#endif
...
#ifdef __CSIO_PORT_EVTQ__
csio_retval_t csio_portevtq_handler(struct csio_q *);
#endif
