...
#define CSIO_STOR_FOISCSI		0x4400
#define CSIO_STOR_COISCSI		0x5500
#define CSIO_CHNET			0x6600
#define CSIO_OS				0x7700
#define CSIO_IMA			0x8800
#define CSIO_ISNS			0x9900
...
#define CSIO_CHNET_IFACE_LINK_UP_IOCTL	0x0002
#define CSIO_CHNET_IFACE_LINK_DOWN_IOCTL	0x0003
#define CSIO_CHNET_IFACE_GET_IOCTL		0x0005
...
#define CSIO_CHNET_IFCONF_IPV4_SET_IOCTL	0x0010
#define CSIO_CHNET_IFCONF_IPV4_GET_IOCTL	0x0011
#define CSIO_CHNET_IFCONF_IPV4_PING_IOCTL	0x0012

#define CSIO_CHNET_IFCONF_IPV4_DHCP_SET_IOCTL	0x0013
#define CSIO_CHNET_IFCONF_IPV4_DHCP_GET_IOCTL	0x0014

#define CSIO_CHNET_IFCONF_VLAN_SET_IOCTL	0x0016
#define CSIO_CHNET_IFCONF_VLAN_GET_IOCTL	0x0017

#define CSIO_CHNET_IFCONF_VLAN_DHCP_SET_IOCTL	0x0019
#define CSIO_CHNET_IFCONF_VLAN_DHCP_GET_IOCTL	0x001a

#define CSIO_CHNET_IFCONF_MTU_SET_IOCTL	0x001c
#define CSIO_CHNET_IFCONF_MTU_GET_IOCTL	0x001d
...
/* IPv6 */
#define CSIO_CHNET_IFCONF_IPV6_SET_IOCTL	0x0029
#define CSIO_CHNET_IFCONF_IPV6_GET_IOCTL	0x002A

#define CSIO_CHNET_IFCONF_IPV6_DHCP_SET_IOCTL	0x002B
#define CSIO_CHNET_IFCONF_IPV6_DHCP_GET_IOCTL	0x002C
#define CSIO_CHNET_IFCONF_IPV6_PING_IOCTL	0x002D
#define CSIO_CHNET_IFCONF_IPV6_PMTU_CLEAR_IOCTL 0x002E

/* COiSCSI target opcodes */
#define CSIO_COISCSI_START_TARGET_IOCTL		0x00D0
#define CSIO_COISCSI_STOP_TARGET_IOCTL		0x00D1
#define CSIO_COISCSI_SHOW_TARGET_IOCTL		0x00D2
#define CSIO_COISCSI_TARGET_INFO_IOCTL		0x00D3
#define CSIO_COISCSI_UPDATE_TARGET_IOCTL	0x00D4
/* iSNS opcodes */
#define CSIO_START_ISNS_IOCTL			0x00D5
#define CSIO_STOP_ISNS_IOCTL			0x00D6
#define CSIO_SHOW_ISNS_IOCTL			0x00D7
#define CSIO_COISCSI_TARGET_STATS_IOCTL		0x00D8
#define CSIO_COISCSI_TARGET_STATS_CLR_IOCTL	0x00D9

#define CSIO_STOR_HW_OPCODE(_x)		(CSIO_STOR_HW | (_x))
#define CSIO_STOR_FCOE_OPCODE(_x)	(CSIO_STOR_FCOE | (_x))
#define CSIO_STOR_FOISCSI_OPCODE(_x)	(CSIO_STOR_FOISCSI | (_x))
#define CSIO_STOR_COISCSI_OPCODE(_x)	(CSIO_STOR_COISCSI | (_x))
#define CSIO_CHNET_OPCODE(_x)		(CSIO_CHNET | (_x))
#define CSIO_OS_OPCODE(_x)		(CSIO_OS | (_x))
#define CSIO_IMA_OPCODE(_x)		(CSIO_IMA | (_x))
#define CSIO_ISNS_OPCODE(_x)		(CSIO_ISNS | (_x))
