...
int tcp_timestamps_enabled(struct net *net)
{
	return net->ipv4.sysctl_tcp_timestamps;
}

int tcp_sack_enabled(struct net *net)
{
	return net->ipv4.sysctl_tcp_sack;
}

int tcp_win_scaling_enabled(struct net *net)
{
...
int tcp_timestamps_enabled(struct net *net)
{
	return t4_get_sysctl_tcp_timestamps(net);
}

int tcp_sack_enabled(struct net *net)
{
	return t4_get_sysctl_tcp_sack(net);
}

int tcp_win_scaling_enabled(struct net *net)
{
	return t4_get_sysctl_tcp_win_scaling(net);
}
