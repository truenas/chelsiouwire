...
int tcp_read_sock_offload(struct sock *sk, read_descriptor_t *desc,
...
EXPORT_SYMBOL(tcp_read_sock_offload);
...
int prepare_tcp_for_offload(void)
{
	...
	offload_inet_stream_ops.read_sock = tcp_read_sock_offload;
	...
	offload_inet6_stream_ops.read_sock = tcp_read_sock_offload;
#endif
