...
#define DRV_VERSION "3.14.0.3-1405"
...
static int cxgbit_uld_control(void *handle, enum cxgb4_control control, ...)
{
	switch (control) {
...
{
	cxgb4_register_uld_type(CXGB4_ULD_ISCSIT, &cxgbit_uld_info);
...
static void __exit cxgbit_exit(void)
{
	...
	cxgb4_unregister_uld_type(CXGB4_ULD_ISCSIT);
}
