...
%define CONFIG_FLAGS --prefix=/usr/chssl --openssldir=%{openssldir}
...
%endif
%ifarch x86_64
./config %{CONFIG_FLAGS} shared threads
%endif
%ifarch aarch64
./config %{CONFIG_FLAGS} shared threads
%endif
...
make -C engines/af_alg/ CHSSLPATH=$RPM_BUILD_ROOT/usr/chssl
install -D -v -m 755 engines/af_alg/libaf_alg.so $RPM_BUILD_ROOT/usr/chssl/lib/engines/
...
%attr(0755,root,root) /usr/chssl/lib/engines/*.so*
