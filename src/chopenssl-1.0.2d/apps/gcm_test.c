 ...
 * cc -o0 -g -o ./gcm gcm_test.c
	-L/root/harsh/sec/dev/T6/linux/tls/openssl-1.0.2d/install/lib -lcrypto
 * export LD_LIBRARY_PATH=/root/harsh/sec/dev/T6/linux/tls/openssl-1.0.2d/install/lib
 */
#include <stdio.h>
...
void aes_gcm_decrypt(void)
{
    ...
    printf("Plaintext:\n");
    BIO_dump_fp(stdout, outbuf, sizeof(gcm_ct));
