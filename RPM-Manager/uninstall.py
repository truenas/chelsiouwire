...
def uninstall():
	...
	os.write(fd,"-----------------------------------------")
	os.write(fd," \nChelsio Unified Wire 3.14.0.3 Installer")
	os.write(fd,"\n-----------------------------------------\n\n")
	os.close(fd)
	...
	ofed_packages = ["compat-rdma", "compat-rdma-devel","kernel-ib", "kernel-ib-devel", "ofed", "ofed-kmp-default", "ib-bonding", 
			 ...
			 "libocrdma-devel", "libocrdma-debuginfo", "libocrdma", "librdmacm1",
        	         ...
        	         "libibverbs", "libibverbs1", "libibverbs-devel", "libibverbs-devel-static",
                	 "libibverbs-utils", "libibverbs-debuginfo", "libibverbs-runtime", "libibverbs1-32bit", 
	                 ...
	                 "librdmacm", "librdmacm-utils", "librdmacm-devel", "librdmacm-debuginfo", "librdmacm-tools",
	...
	chelsio_package = [ "chelsio-series4-firmware", "chcr", "cxgb4nic", "cxgb4", "cxgb4toe", "cxgb4vf", "rdma-block-device",
	                    "cxgbit", "chiwarp", "bonding", "libcxgb4", "libcxgb4-debuginfo", "libcxgb4-devel", "sniffer",
        	            "chfilter", "chtrace", "libiwpm", "libiwpm-debuginfo", "iwpmd", "iwpmd-debuginfo", "libcxgb4_udp", "libcxgb4_sock", "chelsio-utils",
			    "bypass", "chelsio-bypass-utils", "cxgb4toe-ipv4", "libwdtoe","libwdtoe_dbg",
			    "chiscsi", "cxgb4i", "csiostor-initiator", "csiostor-target", "cxgb4ipv6", "chopenssl", "chopenssl-devel", "chopenssl-doc",
			    "cxgb4toe-udpso", "libcxgb4_udp_debug", "libcxgb4_sock_debug", "cxgb4wdtoe", "chfcoe", "oiscsi-utils", "af_alg", "af_alg-debuginfo", "openvswitch",
			    "openvswitch-debuginfo", "openvswitch-devel", "openvswitch-selinux-policy" ]
	debug=0
	to_remove = []
	to_remove_ofed = []
	remove_chssl()
...
def remove_chssl() :
	sts,out = shell('rpm -q af_alg')
	if sts == 0:
		if os.path.isfile("/etc/ssh/sshd_config.chbak") :
			os.system("mv /etc/ssh/sshd_config.chbak /etc/ssh/sshd_config")
		if os.path.isfile("/etc/pki/tls/openssl.cnf.chbak") :
			os.system("mv /etc/pki/tls/openssl.cnf.chbak /etc/pki/tls/openssl.cnf")
		os.system("echo -n \"Restarting ssh service : \" ; service sshd restart &> /dev/null && echo \"Done\"")
