...
base49=`uname -r | grep -c ^4"\."9"\."`
distver=`cat /etc/os-release  2>&1 | grep VERSION_ID | head -1 | awk -F "=" '{print $2}' | awk -F "\"" '{print $2}' | awk -F "." '{print $1}' | tr '[:upper:]' '[:lower:]'`

if [[ ${base75} -eq 1 ]] || [[ ${base49} -eq 1 ]] ; then
	prerequisites_matrix="toe|nic_offload
                      toe_ipv4|nic_ipv4
                      nvme_toe_spdk|nic_offload
                      nvme_toe_spdk_install|nic_offload_install:nvme_toe_spdk_rpm
                      ...
                      fcoe_full_offload_initiator_install|removeallPrevious:nic_offload_install:fcoe_full_offload_initiator_rpm
                      ...
                      fcoe_full_offload_initiator_rpm|nic_offload_rpm:fcoe_full_offload_initiator:firmware_rpm
                      ...
                      crypto|toe
                      crypto_rpm|toe_rpm:chssl_rpm:crypto
                      crypto_install|nic_offload_install:toe_install:crypto_rpm
                      lio|nic_offload
                      lio_rpm|nic_offload_rpm:lio
                      lio_install|nic_offload_install:lio_rpm
                      iser|iwarp
                      iser_rpm|iwarp_rpm:iser
                      iser_install|iwarp_install:iser_rpm
                      dpdk_install|nic_offload_install
                      ovs|nic_offload
                      ovs_rpm|nic_offload_rpm:ovs:tools_rpm
                      ovs_install|nic_offload_install:ovs
                      nvme_install|iwarp_install:nvme_rpm
                      nvme_toe_install|toe_install
                      wdtoe_wdudp_install|wdtoe_install:iwarp_install
                      "

		      
elif [[  ${distver} -eq 8 ]] ; then
	...
	prerequisites_matrix="toe|nic_offload
		      ...
		      iscsi_full_offload_initiator_rpm|fcoe_full_offload_initiator_rpm
                      ...
                      crypto|toe
                      crypto_rpm|toe_rpm:chssl_rpm:crypto
                      crypto_install|nic_offload_install:toe_install:chssl_install
                      lio|nic_offload
                      lio_rpm|nic_offload_rpm:lio
                      lio_install|nic_offload_install:lio_rpm
                      iser|iwarp
...
if [ ${bonding_flag} -eq 1 ] ; then
	prerequisites_matrix+="nic_offload_rpm|nic_offload:firmware_rpm
                      ...
                      bonding_install|removeallPrevious:bonding_rpm:toe_install:tools_install
...
"
	...
	prerequisites_matrix+="nic_offload_rpm|nic_offload:firmware_rpm
                      ...
                      udp_offload|nic_offload:toe
                      udp_offload_install|nic_offload_install:toe_rpm
                      udp_offload_rpm|nic_offload_rpm:udp_offload
...
if [ $4 == 1 ]; then
	prerequisites_matrix="toe|nic_offload
                      toe_ipv4|nic_ipv4
                      nvme_toe_spdk|nic_offload
                      nvme_toe_spdk_install|nic_offload_install:nvme_toe_spdk
                      bonding|toe
                      bypass|ba_tools
                      iwarp|nic_offload:libs
                      udp_offload|nic_offload:bonding
                      ...
                      fcoe_full_offload_initiator_install|removeallPrevious:nic_offload_install:fcoe_full_offload_initiator
                      iscsi_full_offload_initiator_install|fcoe_full_offload_initiator_install
                      ...
                      fcoe_full_offload_initiator_rpm|nic_offload_rpm:fcoe_full_offload_initiator
                      rdma_block_device|iwarp
                      rdma_block_device_rpm|iwarp_rpm:firmware_rpm:rdma_block_device
                      rdma_block_device_install|nic_offload_install:iwarp_install:rdma_block_device_rpm
                      crypto|toe
                      ...
                      iscsi_pdu_initiator_rpm|nic_offload_rpm:iscsi_pdu_initiator:firmware_rpm
                      lio|nic_offload
                      lio_install|nic_offload_install:lio
                      iser|iwarp
                      iser_install|iwarp_install:iser
                      dpdk_install|nic_offload_install
                      ovs|nic_offload
                      ovs_install|nic_offload_install:ovs
                      nvme_install|iwarp_install
...
if [ -f /usr/bin/dpkg ]; then \
	prerequisites_matrix="toe|nic_offload
                      ...
                      fcoe_full_offload_initiator_install|removeallPrevious:nic_offload_install:fcoe_full_offload_initiator_deb
                      iscsi_full_offload_initiator_install|fcoe_full_offload_initiator_install
                      ...
                      fcoe_full_offload_initiator_deb|nic_offload_deb:fcoe_full_offload_initiator:firmware_deb
                      ...
                      crypto|toe
                      crypto_deb|toe_deb:crypto
                      crypto_install|nic_offload_install:toe_install:chssl_install:crypto_deb
                      lio|nic_offload
                      lio_deb|nic_offload_deb:lio
                      lio_install|nic_offload_install:lio_deb
                      iser|iwarp
                      iser_install|iwarp_install:iser
                      dpdk_install|nic_offload_install
                      ovs|nic_offload
...
if [ ${bonding_flag} -eq 1 ] ; then
	prerequisites_matrix+="nic_offload_deb|nic_offload:firmware_deb
                      ...
                      bonding_install|removeallPrevious:bonding_deb:toe_install:tools_install
                      iscsi_pdu_target|bonding
