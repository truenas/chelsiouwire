...
def uninstall():
	...
	chelsio_package = [ "chelsio-series4-firmware", "chtcp", "chcr", "cxgb4nic", "cxgb4", "cxgb4toe", "cxgb4vf", "rdma-block-device",
	                    "cxgbit", "chiwarp", "bonding", "libcxgb4", "libcxgb4-debuginfo", "libcxgb4-devel", "sniffer",
        	            "chfilter", "chtrace", "libiwpm", "libiwpm-debuginfo", "iwpmd-"+iwpmd_vers, "iwpmd-debuginfo", "libcxgb4_udp", "libcxgb4_sock", "chelsio-utils",
			    "bypass", "chelsio-bypass-utils", "cxgb4toe-ipv4", "libwdtoe","libwdtoe_dbg",
			    "chiscsi", "cxgb4i", "csiostor-initiator", "csiostor-target", "cxgb4ipv6", "chopenssl", "chopenssl-devel", "chopenssl-doc", "af_alg", "af_alg-debuginfo",
			    "cxgb4toe-udpso", "libcxgb4_udp_debug", "libcxgb4_sock_debug", "cxgb4wdtoe", "chfcoe", "oiscsi-utils" ]
	debug=0
	to_remove = []
	to_remove_ofed = []
	if ofed:
