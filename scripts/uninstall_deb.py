...
def fixIscsiLink():
	if os.path.isfile('/usr/bin/iscsiadm1'):
        	os.system('mv /usr/bin/iscsiadm1 /usr/bin/iscsiadm')
	if os.path.isfile('/usr/sbin/iscsid1'):
        	os.system('mv /usr/sbin/iscsid1 /usr/sbin/iscsid')
	if os.path.isfile('/usr/sbin/iscsi-iname1'):
        	os.system('mv /usr/sbin/iscsi-iname1 /usr/sbin/iscsi-iname')
...
def uninstall():
	...
	chelsio_package = [ "chelsio-series4-firmware", "chcr", "cxgb4nic", "cxgb4", "cxgb4toe", "cxgb4vf", "chiwarp",
                            "cxgbit", "bonding", "libcxgb4", "libcxgb4-debuginfo", "libcxgb4-devel", "sniffer",
                            "chfilter", "chtrace", "libiwpm", "libiwpm-debuginfo", "iwpmd", "iwpmd-debuginfo", "libcxgb4-udp", "libcxgb4-sock", "chelsio-utils",
